...
Fn.toByteArray = Mu;
Fn.fromByteArray = Su;
var sr = [], He = [], gu = typeof Uint8Array != "undefined" ? Uint8Array : Array, pf = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
for (var fi = 0, bu = pf.length; fi < bu; ++fi)
  sr[fi] = pf[fi], He[pf.charCodeAt(fi)] = fi;
He["-".charCodeAt(0)] = 62;
...
x0.read = function(a, n, o, s, m) {
  var f, g, y = m * 8 - s - 1, S = (1 << y) - 1, B = S >> 1, w = -7, x = o ? m - 1 : 0, I = o ? -1 : 1, k = a[n + x];
  for (x += I, f = k & (1 << -w) - 1, k >>= -w, w += y; w > 0; f = f * 256 + a[n + x], x += I, w -= 8)
    ;
  for (g = f & (1 << -w) - 1, f >>= -w, w += s; w > 0; g = g * 256 + a[n + x], x += I, w -= 8)
    ;
  if (f === 0)
    f = 1 - B;
  else {
...
x0.write = function(a, n, o, s, m, f) {
  var g, y, S, B = f * 8 - m - 1, w = (1 << B) - 1, x = w >> 1, I = m === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0, k = s ? 0 : f - 1, D = s ? 1 : -1, U = n < 0 || n === 0 && 1 / n < 0 ? 1 : 0;
  for (n = Math.abs(n), isNaN(n) || n === 1 / 0 ? (y = isNaN(n) ? 1 : 0, g = w) : (g = Math.floor(Math.log(n) / Math.LN2), n * (S = Math.pow(2, -g)) < 1 && (g--, S *= 2), g + x >= 1 ? n += I / S : n += I * Math.pow(2, 1 - x), n * S >= 2 && (g++, S /= 2), g + x >= w ? (y = 0, g = w) : g + x >= 1 ? (y = (n * S - 1) * Math.pow(2, m), g = g + x) : (y = n * Math.pow(2, x - 1) * Math.pow(2, m), g = 0)); m >= 8; a[o + k] = y & 255, k += D, y /= 256, m -= 8)
    ;
 ...
 */
(function(a) {
  const n = Fn, o = x0, s = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
  ...
  function S(E, M, A) {
    ...
    if (typeof Symbol != "undefined" && Symbol.toPrimitive != null && typeof E[Symbol.toPrimitive] == "function")
      return y.from(E[Symbol.toPrimitive]("string"), M, A);
    throw new TypeError(
      "The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " + typeof E
    );
  }
  y.from = function(E, M, A) {
    return S(E, M, A);
  ...
  function w(E, M, A) {
    return B(E), E <= 0 ? g(E) : M !== void 0 ? typeof A == "string" ? g(E).fill(M, A) : g(E).fill(M) : g(E);
  }
  y.alloc = function(E, M, A) {
    return w(E, M, A);
  };
  function x(E) {
  ...
  function I(E, M) {
    if ((typeof M != "string" || M === "") && (M = "utf8"), !y.isEncoding(M))
  ...
  function k(E) {
    const M = E.length < 0 ? 0 : z(E.length) | 0, A = g(M);
    for (let T = 0; T < M; T += 1)
      A[T] = E[T] & 255;
    return A;
  }
  function D(E) {
    if (dt(E, Uint8Array)) {
      const M = new Uint8Array(E);
      return U(M.buffer, M.byteOffset, M.byteLength);
    }
    return k(E);
  }
  function U(E, M, A) {
    ...
    let T;
    return M === void 0 && A === void 0 ? T = new Uint8Array(E) : A === void 0 ? T = new Uint8Array(E, M) : T = new Uint8Array(E, M, A), Object.setPrototypeOf(T, y.prototype), T;
  }
  function W(E) {
    if (y.isBuffer(E)) {
      const M = z(E.length) | 0, A = g(M);
      return A.length === 0 || E.copy(A, 0, 0, M), A;
    }
    if (E.length !== void 0)
      return typeof E.length != "number" || Pt(E.length) ? g(0) : k(E);
  ...
  y.isBuffer = function(M) {
    return M != null && M._isBuffer === !0 && M !== y.prototype;
  }, y.compare = function(M, A) {
    if (dt(M, Uint8Array) && (M = y.from(M, M.offset, M.byteLength)), dt(A, Uint8Array) && (A = y.from(A, A.offset, A.byteLength)), !y.isBuffer(M) || !y.isBuffer(A))
      throw new TypeError(
        'The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array'
      );
    if (M === A)
      return 0;
    let T = M.length, F = A.length;
  ...
  y.prototype.swap16 = function() {
    ...
    const M = this.length;
    return M === 0 ? "" : arguments.length === 0 ? i(this, 0, M) : H.apply(this, arguments);
  }, y.prototype.toLocaleString = y.prototype.toString, y.prototype.equals = function(M) {
    if (!y.isBuffer(M))
      throw new TypeError("Argument must be a Buffer");
    return this === M ? !0 : y.compare(this, M) === 0;
  }, y.prototype.inspect = function() {
    let M = "";
    const A = a.INSPECT_MAX_BYTES;
    return M = this.toString("hex", 0, A).replace(/(.{2})/g, "$1 ").trim(), this.length > A && (M += " ... "), "<Buffer " + M + ">";
  }, s && (y.prototype[s] = y.prototype.inspect), y.prototype.compare = function(M, A, T, F, V) {
    if (dt(M, Uint8Array) && (M = y.from(M, M.offset, M.byteLength)), !y.isBuffer(M))
      throw new TypeError(
        'The "target" argument must be one of type Buffer or Uint8Array. Received type ' + typeof M
      );
    if (A === void 0 && (A = 0), T === void 0 && (T = M ? M.length : 0), F === void 0 && (F = 0), V === void 0 && (V = this.length), A < 0 || T > M.length || F < 0 || V > this.length)
    ...
    if (A >= T)
      return 1;
    if (A >>>= 0, T >>>= 0, F >>>= 0, V >>>= 0, this === M)
      return 0;
    let L = V - F, X = T - A;
    const Tt = Math.min(L, X), G = this.slice(F, V), rt = M.slice(A, T);
  ...
  function Bt(E, M, A, T, F) {
    if (E.length === 0)
      return -1;
    if (typeof A == "string" ? (T = A, A = 0) : A > 2147483647 ? A = 2147483647 : A < -2147483648 && (A = -2147483648), A = +A, Pt(A) && (A = F ? 0 : E.length - 1), A < 0 && (A = E.length + A), A >= E.length) {
      if (F)
        return -1;
      A = E.length - 1;
    } else if (A < 0)
      if (F)
        ...
        return -1;
    if (typeof M == "string" && (M = y.from(M, T)), y.isBuffer(M))
      return M.length === 0 ? -1 : Ct(E, M, A, T, F);
    if (typeof M == "number")
      return M = M & 255, typeof Uint8Array.prototype.indexOf == "function" ? F ? Uint8Array.prototype.indexOf.call(E, M, A) : Uint8Array.prototype.lastIndexOf.call(E, M, A) : Ct(E, [M], A, T, F);
    throw new TypeError("val must be string, number or Buffer");
  }
  function Ct(E, M, A, T, F) {
    let V = 1, L = E.length, X = M.length;
  ...
  y.prototype.includes = function(M, A, T) {
    return this.indexOf(M, A, T) !== -1;
  }, y.prototype.indexOf = function(M, A, T) {
    return Bt(this, M, A, T, !0);
  }, y.prototype.lastIndexOf = function(M, A, T) {
    return Bt(this, M, A, T, !1);
  };
  function Et(E, M, A, T) {
    A = Number(A) || 0;
    const F = E.length - A;
    ...
    let L;
    for (L = 0; L < T; ++L) {
      const X = parseInt(M.substr(L * 2, 2), 16);
      if (Pt(X))
        return L;
      E[A + L] = X;
    }
  ...
  function Y(E, M, A, T) {
    return j(Nt(M, E.length - A), E, A, T);
  }
  function It(E, M, A, T) {
    return j(et(M), E, A, T);
  }
  ...
  function t(E, M, A, T) {
    return j(pt(M, E.length - A), E, A, T);
  }
  y.prototype.write = function(M, A, T, F) {
    if (A === void 0)
    ...
    if ((T === void 0 || T > V) && (T = V), M.length > 0 && (T < 0 || A < 0) || A > this.length)
  ...
  function r(E, M, A) {
    return M === 0 && A === E.length ? n.fromByteArray(E) : n.fromByteArray(E.slice(M, A));
  }
  function i(E, M, A) {
  ...
  y.prototype.slice = function(M, A) {
    const T = this.length;
    M = ~~M, A = A === void 0 ? T : ~~A, M < 0 ? (M += T, M < 0 && (M = 0)) : M > T && (M = T), A < 0 ? (A += T, A < 0 && (A = 0)) : A > T && (A = T), A < M && (A = M);
    const F = this.subarray(M, A);
  ...
  y.prototype.readUintLE = y.prototype.readUIntLE = function(M, A, T) {
    M = M >>> 0, A = A >>> 0, T || l(M, A, this.length);
    let F = this[M], V = 1, L = 0;
    for (; ++L < A && (V *= 256); )
      F += this[M + L] * V;
    return F;
  }, y.prototype.readUintBE = y.prototype.readUIntBE = function(M, A, T) {
    M = M >>> 0, A = A >>> 0, T || l(M, A, this.length);
    let F = this[M + --A], V = 1;
    for (; A > 0 && (V *= 256); )
      F += this[M + --A] * V;
    return F;
  }, y.prototype.readUint8 = y.prototype.readUInt8 = function(M, A) {
    return M = M >>> 0, A || l(M, 1, this.length), this[M];
  }, y.prototype.readUint16LE = y.prototype.readUInt16LE = function(M, A) {
    return M = M >>> 0, A || l(M, 2, this.length), this[M] | this[M + 1] << 8;
  }, y.prototype.readUint16BE = y.prototype.readUInt16BE = function(M, A) {
    return M = M >>> 0, A || l(M, 2, this.length), this[M] << 8 | this[M + 1];
  }, y.prototype.readUint32LE = y.prototype.readUInt32LE = function(M, A) {
    return M = M >>> 0, A || l(M, 4, this.length), (this[M] | this[M + 1] << 8 | this[M + 2] << 16) + this[M + 3] * 16777216;
  }, y.prototype.readUint32BE = y.prototype.readUInt32BE = function(M, A) {
    return M = M >>> 0, A || l(M, 4, this.length), this[M] * 16777216 + (this[M + 1] << 16 | this[M + 2] << 8 | this[M + 3]);
  ...
  }, y.prototype.readIntBE = function(M, A, T) {
    M = M >>> 0, A = A >>> 0, T || l(M, A, this.length);
    let F = A, V = 1, L = this[M + --F];
    for (; F > 0 && (V *= 256); )
      L += this[M + --F] * V;
    return V *= 128, L >= V && (L -= Math.pow(2, 8 * A)), L;
  }, y.prototype.readInt8 = function(M, A) {
    return M = M >>> 0, A || l(M, 1, this.length), this[M] & 128 ? (255 - this[M] + 1) * -1 : this[M];
  }, y.prototype.readInt16LE = function(M, A) {
    M = M >>> 0, A || l(M, 2, this.length);
    const T = this[M] | this[M + 1] << 8;
    return T & 32768 ? T | 4294901760 : T;
  }, y.prototype.readInt16BE = function(M, A) {
    M = M >>> 0, A || l(M, 2, this.length);
    const T = this[M + 1] | this[M] << 8;
    return T & 32768 ? T | 4294901760 : T;
  }, y.prototype.readInt32LE = function(M, A) {
    return M = M >>> 0, A || l(M, 4, this.length), this[M] | this[M + 1] << 8 | this[M + 2] << 16 | this[M + 3] << 24;
  }, y.prototype.readInt32BE = function(M, A) {
    return M = M >>> 0, A || l(M, 4, this.length), this[M] << 24 | this[M + 1] << 16 | this[M + 2] << 8 | this[M + 3];
  ...
  }), y.prototype.readFloatLE = function(M, A) {
    return M = M >>> 0, A || l(M, 4, this.length), o.read(this, M, !0, 23, 4);
  }, y.prototype.readFloatBE = function(M, A) {
    return M = M >>> 0, A || l(M, 4, this.length), o.read(this, M, !1, 23, 4);
  }, y.prototype.readDoubleLE = function(M, A) {
    return M = M >>> 0, A || l(M, 8, this.length), o.read(this, M, !0, 52, 8);
  }, y.prototype.readDoubleBE = function(M, A) {
    return M = M >>> 0, A || l(M, 8, this.length), o.read(this, M, !1, 52, 8);
  };
  function b(E, M, A, T, F, V) {
    if (!y.isBuffer(E))
  ...
  y.prototype.writeUintLE = y.prototype.writeUIntLE = function(M, A, T, F) {
    if (M = +M, A = A >>> 0, T = T >>> 0, !F) {
      const X = Math.pow(2, 8 * T) - 1;
      b(this, M, A, T, X, 0);
    }
    let V = 1, L = 0;
    for (this[A] = M & 255; ++L < T && (V *= 256); )
      this[A + L] = M / V & 255;
    return A + T;
  }, y.prototype.writeUintBE = y.prototype.writeUIntBE = function(M, A, T, F) {
    if (M = +M, A = A >>> 0, T = T >>> 0, !F) {
      const X = Math.pow(2, 8 * T) - 1;
      b(this, M, A, T, X, 0);
    }
    let V = T - 1, L = 1;
    for (this[A + V] = M & 255; --V >= 0 && (L *= 256); )
      this[A + V] = M / L & 255;
    return A + T;
  }, y.prototype.writeUint8 = y.prototype.writeUInt8 = function(M, A, T) {
    return M = +M, A = A >>> 0, T || b(this, M, A, 1, 255, 0), this[A] = M & 255, A + 1;
  }, y.prototype.writeUint16LE = y.prototype.writeUInt16LE = function(M, A, T) {
    return M = +M, A = A >>> 0, T || b(this, M, A, 2, 65535, 0), this[A] = M & 255, this[A + 1] = M >>> 8, A + 2;
  }, y.prototype.writeUint16BE = y.prototype.writeUInt16BE = function(M, A, T) {
    return M = +M, A = A >>> 0, T || b(this, M, A, 2, 65535, 0), this[A] = M >>> 8, this[A + 1] = M & 255, A + 2;
  }, y.prototype.writeUint32LE = y.prototype.writeUInt32LE = function(M, A, T) {
    return M = +M, A = A >>> 0, T || b(this, M, A, 4, 4294967295, 0), this[A + 3] = M >>> 24, this[A + 2] = M >>> 16, this[A + 1] = M >>> 8, this[A] = M & 255, A + 4;
  }, y.prototype.writeUint32BE = y.prototype.writeUInt32BE = function(M, A, T) {
    return M = +M, A = A >>> 0, T || b(this, M, A, 4, 4294967295, 0), this[A] = M >>> 24, this[A + 1] = M >>> 16, this[A + 2] = M >>> 8, this[A + 3] = M & 255, A + 4;
  };
  function _(E, M, A, T, F) {
    Z(M, T, F, E, A, 7);
    let V = Number(M & BigInt(4294967295));
  ...
  y.prototype.writeBigUInt64LE = ct(function(M, A = 0) {
    return _(this, M, A, BigInt(0), BigInt("0xffffffffffffffff"));
  }), y.prototype.writeBigUInt64BE = ct(function(M, A = 0) {
    return C(this, M, A, BigInt(0), BigInt("0xffffffffffffffff"));
  }), y.prototype.writeIntLE = function(M, A, T, F) {
    if (M = +M, A = A >>> 0, !F) {
      const Tt = Math.pow(2, 8 * T - 1);
      b(this, M, A, T, Tt - 1, -Tt);
    }
    let V = 0, L = 1, X = 0;
    for (this[A] = M & 255; ++V < T && (L *= 256); )
      M < 0 && X === 0 && this[A + V - 1] !== 0 && (X = 1), this[A + V] = (M / L >> 0) - X & 255;
    return A + T;
  }, y.prototype.writeIntBE = function(M, A, T, F) {
    if (M = +M, A = A >>> 0, !F) {
      const Tt = Math.pow(2, 8 * T - 1);
      b(this, M, A, T, Tt - 1, -Tt);
    }
    ...
    for (this[A + V] = M & 255; --V >= 0 && (L *= 256); )
      M < 0 && X === 0 && this[A + V + 1] !== 0 && (X = 1), this[A + V] = (M / L >> 0) - X & 255;
    return A + T;
  }, y.prototype.writeInt8 = function(M, A, T) {
    return M = +M, A = A >>> 0, T || b(this, M, A, 1, 127, -128), M < 0 && (M = 255 + M + 1), this[A] = M & 255, A + 1;
  }, y.prototype.writeInt16LE = function(M, A, T) {
    return M = +M, A = A >>> 0, T || b(this, M, A, 2, 32767, -32768), this[A] = M & 255, this[A + 1] = M >>> 8, A + 2;
  }, y.prototype.writeInt16BE = function(M, A, T) {
    return M = +M, A = A >>> 0, T || b(this, M, A, 2, 32767, -32768), this[A] = M >>> 8, this[A + 1] = M & 255, A + 2;
  }, y.prototype.writeInt32LE = function(M, A, T) {
    return M = +M, A = A >>> 0, T || b(this, M, A, 4, 2147483647, -2147483648), this[A] = M & 255, this[A + 1] = M >>> 8, this[A + 2] = M >>> 16, this[A + 3] = M >>> 24, A + 4;
  }, y.prototype.writeInt32BE = function(M, A, T) {
    return M = +M, A = A >>> 0, T || b(this, M, A, 4, 2147483647, -2147483648), M < 0 && (M = 4294967295 + M + 1), this[A] = M >>> 24, this[A + 1] = M >>> 16, this[A + 2] = M >>> 8, this[A + 3] = M & 255, A + 4;
  }, y.prototype.writeBigInt64LE = ct(function(M, A = 0) {
    return _(this, M, A, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"));
  }), y.prototype.writeBigInt64BE = ct(function(M, A = 0) {
    return C(this, M, A, -BigInt("0x8000000000000000"), BigInt("0x7fffffffffffffff"));
  });
  function q(E, M, A, T, F, V) {
    if (A + T > E.length)
      throw new RangeError("Index out of range");
    if (A < 0)
      throw new RangeError("Index out of range");
  }
  function O(E, M, A, T, F) {
    return M = +M, A = A >>> 0, F || q(E, M, A, 4), o.write(E, M, A, T, 23, 4), A + 4;
  }
  y.prototype.writeFloatLE = function(M, A, T) {
    return O(this, M, A, !0, T);
  }, y.prototype.writeFloatBE = function(M, A, T) {
    return O(this, M, A, !1, T);
  };
  function R(E, M, A, T, F) {
    return M = +M, A = A >>> 0, F || q(E, M, A, 8), o.write(E, M, A, T, 52, 8), A + 8;
  }
  y.prototype.writeDoubleLE = function(M, A, T) {
    return R(this, M, A, !0, T);
  }, y.prototype.writeDoubleBE = function(M, A, T) {
    return R(this, M, A, !1, T);
  }, y.prototype.copy = function(M, A, T, F) {
    if (!y.isBuffer(M))
      throw new TypeError("argument should be a Buffer");
    if (T || (T = 0), !F && F !== 0 && (F = this.length), A >= M.length && (A = M.length), A || (A = 0), F > 0 && F < T && (F = T), F === T || M.length === 0 || this.length === 0)
      return 0;
    if (A < 0)
    ...
    F > this.length && (F = this.length), M.length - A < F - T && (F = M.length - A + T);
    const V = F - T;
    return this === M && typeof Uint8Array.prototype.copyWithin == "function" ? this.copyWithin(A, T, F) : Uint8Array.prototype.set.call(
      M,
      this.subarray(T, F),
      A
    ), V;
  }, y.prototype.fill = function(M, A, T, F) {
    if (typeof M == "string") {
    ...
    if (T <= A)
      return this;
    A = A >>> 0, T = T === void 0 ? this.length : T >>> 0, M || (M = 0);
    let V;
    if (typeof M == "number")
      for (V = A; V < T; ++V)
        this[V] = M;
    else {
      const L = y.isBuffer(M) ? M : y.from(M, F), X = L.length;
      if (X === 0)
  ...
  N(
    ...
    function(E, M, A) {
      ...
      return Number.isInteger(A) && Math.abs(A) > me(2, 32) ? F = K(String(A)) : typeof A == "bigint" && (F = String(A), (A > me(BigInt(2), BigInt(32)) || A < -me(BigInt(2), BigInt(32))) && (F = K(F)), F += "n"), T += ` It must be ${M}. Received ${F}`, T;
    },
    RangeError
  );
  function K(E) {
  ...
  function Z(E, M, A, T, F, V) {
    if (E > A || E < M) {
      ...
      let X;
      throw V > 3 ? M === 0 || M === BigInt(0) ? X = `>= 0${L} and < 2${L} ** ${(V + 1) * 8}${L}` : X = `>= -(2${L} ** ${(V + 1) * 8 - 1}${L}) and < 2 ** ${(V + 1) * 8 - 1}${L}` : X = `>= ${M}${L} and <= ${A}${L}`, new P.ERR_OUT_OF_RANGE("value", X, E);
    }
    kt(T, F, V);
  }
  function J(E, M) {
  ...
  function Nt(E, M) {
    ...
    for (let L = 0; L < T; ++L) {
      if (A = E.charCodeAt(L), A > 55295 && A < 57344) {
        ...
        if (A < 56320) {
          (M -= 3) > -1 && V.push(239, 191, 189), F = A;
          continue;
        }
        A = (F - 55296 << 10 | A - 56320) + 65536;
      } else
        F && (M -= 3) > -1 && V.push(239, 191, 189);
      if (F = null, A < 128) {
        if ((M -= 1) < 0)
          break;
        V.push(A);
  ...
  function pt(E, M) {
    let A, T, F;
    const V = [];
    for (let L = 0; L < E.length && !((M -= 2) < 0); ++L)
  ...
  function j(E, M, A, T) {
    let F;
    for (F = 0; F < T && !(F + A >= M.length || F >= E.length); ++F)
      M[F + A] = E[F];
    return F;
  }
  function dt(E, M) {
  ...
  function ct(E) {
    return typeof BigInt == "undefined" ? Ot : E;
  }
  function Ot() {
...
function e0(a) {
  if (!a || typeof a != "object" || Array.isArray(a))
    return a;
  const n = a, o = n["custom.source"], s = n.custom, m = s && typeof s == "object" && !Array.isArray(s) ? s.source : void 0, f = typeof o == "string" ? o : typeof m == "string" ? m : "SDK";
  return vf(ni({}, n), {
    custom: s && typeof s == "object" && !Array.isArray(s) ? vf(ni({}, s), {
      source: f
    }) : { source: f }
  });
}
...
function ki(a, n, o) {
  const s = Bu();
  return ["staging", "sandbox", "acceptance", "local", "testing", "development"].includes(s) && o ? !0 : s === "production" ? Au.some(
...
class ku {
  constructor(n, o, s = 5, m = 1e3) {
    this.wsUrl = n, this.apiKey = o, this.maxRetries = s, this.initialBackoffMs = m, this.socket = null, this.flags = {}, this.context = null, this.isReady = !1, this.initialFlagsReceived = !1, this.initialFlagsPromise = null, this.initialFlagsResolve = null, this.initialFlagsReject = null, this.retries = 0, this.reconnectTimeoutId = null;
  }
  init() {
    return Ie(this, null, function* () {
  ...
  waitForInitialFlags() {
    return this.initialFlagsReceived ? Promise.resolve() : (this.initialFlagsPromise || (this.initialFlagsPromise = new Promise((n, o) => {
      this.initialFlagsResolve = n, this.initialFlagsReject = o;
          ...
          this.socket = new m(`${this.wsUrl}?apiKey=${this.apiKey}`), this.socket.onopen = () => {
            ...
            if (Ft.log("[WebSocketTransport] Connection closed:", f.code), this.isReady = !1, this.setConnectionState("disconnected"), f.code === 1008 || f.code === 4001) {
              ...
              const B = (g = f.reason) != null ? g : "", x = B.toLowerCase().includes("rate limit") || B.toLowerCase().includes("too many") ? Object.assign(new Error(B || "Rate limit exceeded. Please try again later."), {
                ...
                resetTime: (S = (y = B.match(/after (.+)$/i)) == null ? void 0 : y[1]) == null ? void 0 : S.trim()
              }) : Object.assign(new Error("Unauthorized: Invalid API key"), { code: "ERR_AUTH" });
              this.initialFlagsReject && (this.initialFlagsReject(x), this.initialFlagsReject = null, this.initialFlagsResolve = null), o(x);
              return;
            }
  ...
  fetchFlags(n) {
    return Ie(this, null, function* () {
      var o;
      return this.context = e0(n), this.isReady && ((o = this.socket) == null ? void 0 : o.readyState) === 1 && (this.sendContext(this.context), this.initialFlagsReceived ? yield new Promise((s) => setTimeout(s, 200)) : yield this.waitForInitialFlags()), this.flags;
    });
  }
  onFlagsUpdated(n) {
...
var zt = i0.exports, mf = 65536, il = 4294967295;
function nl() {
  throw new Error(`Secure random number generation is not supported by this browser.
Use Chrome, Firefox or Internet Explorer 11`);
}
var fl = zt.Buffer, _n = Xt.crypto || Xt.msCrypto;
_n && _n.getRandomValues ? r0.exports = al : r0.exports = nl;
function al(a, n) {
  if (a > il)
  ...
  if (a > 0)
    if (a > mf)
      for (var s = 0; s < a; s += mf)
        _n.getRandomValues(o.slice(s, s + mf));
    else
...
var yi = r0.exports, n0 = { exports: {} };
typeof Object.create == "function" ? n0.exports = function(n, o) {
...
function Re(a, n, o, s, m, f, g) {
  return Pn(a + (n & o | ~n & s) + m + f | 0, g) + n | 0;
}
function Te(a, n, o, s, m, f, g) {
  return Pn(a + (n & s | o & ~s) + m + f | 0, g) + n | 0;
}
function Ce(a, n, o, s, m, f, g) {
  return Pn(a + (n ^ o ^ s) + m + f | 0, g) + n | 0;
}
function Fe(a, n, o, s, m, f, g) {
  return Pn(a + (o ^ (n | ~s)) + m + f | 0, g) + n | 0;
}
var _0 = qn, gf = br.Buffer, ml = Gt, Dh = qh, gl = new Array(16), Ii = [
  0,
  1,
  2,
  3,
...
Dn.prototype._update = function() {
  for (var a = gl, n = 0; n < 16; ++n)
    a[n] = this._block.readInt32LE(n * 4);
  for (var o = this._a | 0, s = this._b | 0, m = this._c | 0, f = this._d | 0, g = this._e | 0, y = this._a | 0, S = this._b | 0, B = this._c | 0, w = this._d | 0, x = this._e | 0, I = 0; I < 80; I += 1) {
    var k, D;
    I < 16 ? (k = fa(o, s, m, f, g, a[Ii[I]], Fi[0], Ti[I]), D = oa(y, S, B, w, x, a[Ri[I]], qi[0], Ci[I])) : I < 32 ? (k = aa(o, s, m, f, g, a[Ii[I]], Fi[1], Ti[I]), D = sa(y, S, B, w, x, a[Ri[I]], qi[1], Ci[I])) : I < 48 ? (k = ha(o, s, m, f, g, a[Ii[I]], Fi[2], Ti[I]), D = ha(y, S, B, w, x, a[Ri[I]], qi[2], Ci[I])) : I < 64 ? (k = sa(o, s, m, f, g, a[Ii[I]], Fi[3], Ti[I]), D = aa(y, S, B, w, x, a[Ri[I]], qi[3], Ci[I])) : (k = oa(o, s, m, f, g, a[Ii[I]], Fi[4], Ti[I]), D = fa(y, S, B, w, x, a[Ri[I]], qi[4], Ci[I])), o = g, g = f, f = Xr(m, 10), m = s, s = k, y = x, x = w, w = Xr(B, 10), B = S, S = D;
  }
  var U = this._b + m + w | 0;
  this._b = this._c + f + x | 0, this._c = this._d + g + y | 0, this._d = this._e + o + S | 0, this._e = this._a + s + B | 0, this._a = U;
};
Dn.prototype._digest = function() {
  this._block[this._blockOffset++] = 128, this._blockOffset > 56 && (this._block.fill(0, this._blockOffset, 64), this._update(), this._blockOffset = 0), this._block.fill(0, this._blockOffset, 56), this._block.writeUInt32LE(this._length[0], 56), this._block.writeUInt32LE(this._length[1], 60), this._update();
  var a = gf.alloc ? gf.alloc(20) : new gf(20);
...
Nn.prototype.digest = function(a) {
...
var wi = Nn, bl = Gt, Lh = wi, yl = zt.Buffer, wl = [
  1518500249,
  1859775393,
  -1894007588,
  -899497514
...
Yi.prototype._update = function(a) {
  ...
  for (var S = 0; S < 80; ++S) {
    var B = ~~(S / 20), w = xl(o) + Sl(B, s, m, f) + g + n[S] + wl[B] | 0;
    g = f, f = m, m = _l(s), s = o, o = w;
  }
...
Ji.prototype._update = function(a) {
  ...
  for (var S = 0; S < 80; ++S) {
    var B = ~~(S / 20), w = Tl(o) + Fl(B, s, m, f) + g + n[S] + kl[B] | 0;
    g = f, f = m, m = Cl(s), s = o, o = w;
  }
  this._a = o + this._a | 0, this._b = s + this._b | 0, this._c = m + this._c | 0, this._d = f + this._d | 0, this._e = g + this._e | 0;
};
...
Gi.prototype._update = function(a) {
  for (var n = this._w, o = this._a | 0, s = this._b | 0, m = this._c | 0, f = this._d | 0, g = this._e | 0, y = this._f | 0, S = this._g | 0, B = this._h | 0, w = 0; w < 16; ++w)
    n[w] = a.readInt32BE(w * 4);
  for (; w < 64; ++w)
    n[w] = Hl(n[w - 2]) + n[w - 7] + Kl(n[w - 15]) + n[w - 16] | 0;
  for (var x = 0; x < 64; ++x) {
...
var Gl = $n, Xl = Gt, Kh = wi, jl = zt.Buffer, ua = [
  1116352408,
  3609767458,
  1899447441,
  602891725,
...
Xi.prototype._update = function(a) {
  for (var n = this._w, o = this._ah | 0, s = this._bh | 0, m = this._ch | 0, f = this._dh | 0, g = this._eh | 0, y = this._fh | 0, S = this._gh | 0, B = this._hh | 0, w = this._al | 0, x = this._bl | 0, I = this._cl | 0, k = this._dl | 0, D = this._el | 0, U = this._fl | 0, W = this._gl | 0, z = this._hl | 0, $ = 0; $ < 32; $ += 2)
...
var od = Ln, ei = Nh.exports = function(n) {
  n = n.toLowerCase();
  var o = ei[n];
  if (!o)
...
ei.sha384 = od;
ei.sha512 = Hh;
var A0 = Nh.exports, Sn = {}, f0 = { exports: {} };
(function(a, n) {
  var o = br, s = o.Buffer;
  function m(g, y) {
    for (var S in g)
...
var ud = f0.exports, B0 = ud.Buffer, pa = B0.isEncoding || function(a) {
...
function dd(a) {
  var n = ld(a);
  if (typeof n != "string" && (B0.isEncoding === pa || !pa(a)))
...
function ji(a) {
  ...
  this.lastNeed = 0, this.lastTotal = 0, this.lastChar = B0.allocUnsafe(n);
}
...
function cd(a, n, o) {
  ...
  if (s < o)
    return 0;
  var m = bf(n[s]);
  return m >= 0 ? (m > 0 && (a.lastNeed = m - 1), m) : --s < o || m === -2 ? 0 : (m = bf(n[s]), m >= 0 ? (m > 0 && (a.lastNeed = m - 2), m) : --s < o || m === -2 ? 0 : (m = bf(n[s]), m >= 0 ? (m > 0 && (m === 2 ? m = 0 : a.lastNeed = m - 3), m) : 0));
}
function vd(a, n, o) {
  if ((n[0] & 192) !== 128)
    return a.lastNeed = 0, "�";
...
var Lr = rr, Id = Gt, Rd = _0, Td = S0, Cd = A0, Wh = Lr;
function Un(a) {
...
var Qi = function(n) {
  return n = n.toLowerCase(), n === "md5" ? new Rd() : n === "rmd160" || n === "ripemd160" ? new Td() : new Un(Cd(n));
...
Fd(On, Vh);
On.prototype._update = function(a) {
  this._hash.push(a);
};
...
function Hi(a, n) {
  ...
  this._hash = a === "rmd160" ? new a0() : h0(a), this._hash.update(m);
}
Nd(Hi, Jh);
...
Hi.prototype._final = function() {
  var a = this._hash.digest(), n = this._alg === "rmd160" ? new a0() : h0(this._alg);
...
var jd = Xh, zn = {}, Qd = Math.pow(2, 30) - 1, jh = function(a, n) {
  if (typeof a != "number")
...
if (Xt.process && Xt.process.browser)
  ...
  yn = "utf-8";
var Qh = yn, yf = zt.Buffer, ts = function(a, n, o) {
  if (yf.isBuffer(a))
    return a;
  if (typeof a == "string")
    return yf.from(a, n);
  if (ArrayBuffer.isView(a))
    return yf.from(a.buffer);
  throw new TypeError(o + " must be a string, a Buffer, a typed array or a DataView");
}, ec = Yh, rc = S0, ic = A0, Yr = zt.Buffer, nc = jh, ma = Qh, ga = ts, fc = Yr.alloc(128), wn = {
  md5: 16,
  sha1: 20,
  sha224: 28,
  sha256: 32,
...
function hc(a, n, o, s, m) {
  ...
  for (var S = 0, B = wn[m], w = Math.ceil(s / B), x = 1; x <= w; x++) {
...
cr.prototype._encrypt = function(n, o, s, m, f) {
  for (var g = o, y = s, S = 0; S < n.keys.length; S += 2) {
    var B = n.keys[S], w = n.keys[S + 1];
    xe.expand(y, n.tmp, 0), B ^= n.tmp[0], w ^= n.tmp[1];
    var x = xe.substitute(B, w), I = xe.permute(x), k = y;
    y = (g ^ I) >>> 0, g = k;
  }
  xe.rip(y, g, m, f);
};
cr.prototype._decrypt = function(n, o, s, m, f) {
  for (var g = s, y = o, S = n.keys.length - 2; S >= 0; S -= 2) {
    var B = n.keys[S], w = n.keys[S + 1];
    xe.expand(g, n.tmp, 0), B ^= n.tmp[0], w ^= n.tmp[1];
    var x = xe.substitute(B, w), I = xe.permute(x), k = g;
    g = (y ^ I) >>> 0, y = k;
  }
  xe.rip(g, y, m, f);
};
...
Kn.prototype._update = function(a) {
  return Zr.from(this._des.update(a));
};
Kn.prototype._final = function() {
...
var R0 = {}, or = [], Ze = [], Ec = typeof Uint8Array != "undefined" ? Uint8Array : Array, T0 = !1;
function ds() {
  T0 = !0;
...
function C0(a, n) {
  if (ms(n), a = _r(a, n < 0 ? 0 : F0(n) | 0), !mt.TYPED_ARRAY_SUPPORT)
    for (var o = 0; o < n; ++o)
      a[o] = 0;
  return a;
}
...
function o0(a, n) {
  var o = n.length < 0 ? 0 : F0(n.length) | 0;
  a = _r(a, o);
  for (var s = 0; s < o; s += 1)
    a[s] = n[s] & 255;
  return a;
...
function Pc(a, n, o, s) {
  ...
  return o === void 0 && s === void 0 ? n = new Uint8Array(n) : s === void 0 ? n = new Uint8Array(n, o) : n = new Uint8Array(n, o, s), mt.TYPED_ARRAY_SUPPORT ? (a = n, a.__proto__ = mt.prototype) : a = o0(a, n), a;
}
function Dc(a, n) {
  if (vr(n)) {
    var o = F0(n.length) | 0;
  ...
  if (n) {
    if (typeof ArrayBuffer != "undefined" && n.buffer instanceof ArrayBuffer || "length" in n)
      return typeof n.length != "number" || e1(n.length) ? _r(a, 0) : o0(a, n);
...
mt.prototype.compare = function(n, o, s, m, f) {
  ...
  if (o >>>= 0, s >>>= 0, m >>>= 0, f >>>= 0, this === n)
    return 0;
  for (var g = f - m, y = s - o, S = Math.min(g, y), B = this.slice(m, f), w = n.slice(o, s), x = 0; x < S; ++x)
    if (B[x] !== w[x]) {
      g = B[x], y = w[x];
      break;
    }
...
function Lc(a, n, o, s) {
  return Vn(En(n, a.length - o), a, o, s);
}
function ys(a, n, o, s) {
  return Vn(Qc(n), a, o, s);
}
function Uc(a, n, o, s) {
  return ys(a, n, o, s);
}
function Oc(a, n, o, s) {
  return Vn(Ss(n), a, o, s);
}
function zc(a, n, o, s) {
  return Vn(t1(n, a.length - o), a, o, s);
}
    ...
    if (m + y <= o) {
      ...
      switch (y) {
        ...
        case 3:
          ...
          break;
        case 4:
          S = a[m + 1], B = a[m + 2], w = a[m + 3], (S & 192) === 128 && (B & 192) === 128 && (w & 192) === 128 && (x = (f & 15) << 18 | (S & 63) << 12 | (B & 63) << 6 | w & 63, x > 65535 && x < 1114112 && (g = x));
      }
    }
...
mt.prototype.readFloatLE = function(n, o) {
  return o || Be(n, 4, this.length), Hn(this, n, !0, 23, 4);
};
mt.prototype.readFloatBE = function(n, o) {
  return o || Be(n, 4, this.length), Hn(this, n, !1, 23, 4);
};
mt.prototype.readDoubleLE = function(n, o) {
  return o || Be(n, 8, this.length), Hn(this, n, !0, 52, 8);
};
mt.prototype.readDoubleBE = function(n, o) {
  return o || Be(n, 8, this.length), Hn(this, n, !1, 52, 8);
};
...
mt.prototype.writeUInt32LE = function(n, o, s) {
  return n = +n, o = o | 0, s || Ue(this, n, o, 4, 4294967295, 0), mt.TYPED_ARRAY_SUPPORT ? (this[o + 3] = n >>> 24, this[o + 2] = n >>> 16, this[o + 1] = n >>> 8, this[o] = n & 255) : Wn(this, n, o, !0), o + 4;
};
mt.prototype.writeUInt32BE = function(n, o, s) {
  return n = +n, o = o | 0, s || Ue(this, n, o, 4, 4294967295, 0), mt.TYPED_ARRAY_SUPPORT ? (this[o] = n >>> 24, this[o + 1] = n >>> 16, this[o + 2] = n >>> 8, this[o + 3] = n & 255) : Wn(this, n, o, !1), o + 4;
};
...
mt.prototype.writeInt32LE = function(n, o, s) {
  return n = +n, o = o | 0, s || Ue(this, n, o, 4, 2147483647, -2147483648), mt.TYPED_ARRAY_SUPPORT ? (this[o] = n & 255, this[o + 1] = n >>> 8, this[o + 2] = n >>> 16, this[o + 3] = n >>> 24) : Wn(this, n, o, !0), o + 4;
};
mt.prototype.writeInt32BE = function(n, o, s) {
  return n = +n, o = o | 0, s || Ue(this, n, o, 4, 2147483647, -2147483648), n < 0 && (n = 4294967295 + n + 1), mt.TYPED_ARRAY_SUPPORT ? (this[o] = n >>> 24, this[o + 1] = n >>> 16, this[o + 2] = n >>> 8, this[o + 3] = n & 255) : Wn(this, n, o, !1), o + 4;
};
...
function f1(a, n, o) {
  ...
  return a._prev = u0.concat([
    a._prev.slice(1),
    u0.from([o ? n : m])
  ]), m;
}
ks.encrypt = function(a, n, o) {
  for (var s = n.length, m = u0.allocUnsafe(s), f = -1; ++f < s; )
    m[f] = f1(a, n[f], o);
  return m;
};
var Is = {}, Mn = zt.Buffer;
...
var Mf = 16;
l0.encrypt = function(a, n) {
  var o = Math.ceil(n.length / Mf), s = a._cache.length;
  a._cache = Ea.concat([
    a._cache,
    Ea.allocUnsafe(o * Mf)
  ]);
...
function Fs(a, n, o, s, m) {
  for (var f = o[0], g = o[1], y = o[2], S = o[3], B = a[0] ^ n[0], w = a[1] ^ n[1], x = a[2] ^ n[2], I = a[3] ^ n[3], k, D, U, W, z = 4, $ = 1; $ < m; $++)
    k = f[B >>> 24] ^ g[w >>> 16 & 255] ^ y[x >>> 8 & 255] ^ S[I & 255] ^ n[z++], D = f[w >>> 24] ^ g[x >>> 16 & 255] ^ y[I >>> 8 & 255] ^ S[B & 255] ^ n[z++], U = f[x >>> 24] ^ g[I >>> 16 & 255] ^ y[B >>> 8 & 255] ^ S[w & 255] ^ n[z++], W = f[I >>> 24] ^ g[B >>> 16 & 255] ^ y[w >>> 8 & 255] ^ S[x & 255] ^ n[z++], B = k, w = D, x = U, I = W;
  return k = (s[B >>> 24] << 24 | s[w >>> 16 & 255] << 16 | s[x >>> 8 & 255] << 8 | s[I & 255]) ^ n[z++], D = (s[w >>> 24] << 24 | s[x >>> 16 & 255] << 16 | s[I >>> 8 & 255] << 8 | s[B & 255]) ^ n[z++], U = (s[x >>> 24] << 24 | s[I >>> 16 & 255] << 16 | s[B >>> 8 & 255] << 8 | s[w & 255]) ^ n[z++], W = (s[I >>> 24] << 24 | s[B >>> 16 & 255] << 16 | s[w >>> 8 & 255] << 8 | s[x & 255]) ^ n[z++], k = k >>> 0, D = D >>> 0, U = U >>> 0, W = W >>> 0, [k, D, U, W];
}
var b1 = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54], ye = function() {
  ...
  for (var o = [], s = [], m = [[], [], [], []], f = [[], [], [], []], g = 0, y = 0, S = 0; S < 256; ++S) {
    ...
    var w = a[g], x = a[w], I = a[x], k = a[B] * 257 ^ B * 16843008;
    m[0][g] = k << 24 | k >>> 8, m[1][g] = k << 16 | k >>> 16, m[2][g] = k << 8 | k >>> 24, m[3][g] = k, k = I * 16843009 ^ x * 65537 ^ w * 257 ^ g * 16843008, f[0][B] = k << 24 | k >>> 8, f[1][B] = k << 16 | k >>> 16, f[2][B] = k << 8 | k >>> 24, f[3][B] = k, g === 0 ? g = y = 1 : (g = w ^ a[a[a[I ^ w]]], y ^= a[a[y]]);
  }
  return {
    SBOX: o,
    INV_SBOX: s,
...
We.prototype._reset = function() {
  ...
  for (var y = [], S = 0; S < s; S++) {
    var B = s - S, w = m[B - (S % 4 ? 0 : 4)];
    S < 4 || B <= 4 ? y[S] = w : y[S] = ye.INV_SUB_MIX[0][ye.SBOX[w >>> 24]] ^ ye.INV_SUB_MIX[1][ye.SBOX[w >>> 16 & 255]] ^ ye.INV_SUB_MIX[2][ye.SBOX[w >>> 8 & 255]] ^ ye.INV_SUB_MIX[3][ye.SBOX[w & 255]];
  }
  this._nRounds = o, this._keySchedule = m, this._invKeySchedule = y;
};
We.prototype.encryptBlockRaw = function(a) {
  return a = P0(a), Fs(a, this._keySchedule, ye.SUB_MIX, ye.SBOX, this._nRounds);
};
...
We.prototype.scrub = function() {
  xf(this._keySchedule), xf(this._invKeySchedule), xf(this._key);
};
en.AES = We;
...
var Ns = ri, k1 = en, _f = zt.Buffer, $s = Lr, I1 = Gt;
function Yn(a, n, o, s) {
  $s.call(this), this._cipher = new k1.AES(n), this._prev = _f.from(o), this._cache = _f.allocUnsafe(0), this._secCache = _f.allocUnsafe(0), this._decrypt = s, this._mode = a;
}
I1(Yn, $s);
Yn.prototype._update = function(a) {
  return this._mode.encrypt(this, a, this._decrypt);
};
Yn.prototype._final = function() {
  this._cipher.scrub();
};
var Ls = Yn, zr = zt.Buffer, R1 = _0;
function T1(a, n, o, s) {
  ...
  for (var m = o / 8, f = zr.alloc(m), g = zr.alloc(s || 0), y = zr.alloc(0); m > 0 || s > 0; ) {
    ...
    if (m > 0) {
      var w = f.length - m;
      B = Math.min(m, y.length), y.copy(f, w, 0, B), m -= B;
    }
    if (B < y.length && s > 0) {
...
var Jn = T1, Us = q0, C1 = Ns, Br = zt.Buffer, F1 = Ls, Os = Lr, q1 = en, P1 = Jn, D1 = Gt;
function nn(a, n, o) {
  Os.call(this), this._cache = new Gn(), this._cipher = new q1.AES(n), this._prev = Br.from(o), this._mode = a, this._autopadding = !0;
}
D1(nn, Os);
...
k0.createCipheriv = zs;
k0.createCipher = $1;
var D0 = {}, L1 = Ns, di = zt.Buffer, Ks = q0, U1 = Ls, Hs = Lr, O1 = en, z1 = Jn, K1 = Gt;
function fn(a, n, o) {
  Hs.call(this), this._cache = new Xn(), this._last = void 0, this._cipher = new O1.AES(n), this._prev = di.from(o), this._mode = a, this._autopadding = !0;
}
K1(fn, Hs);
...
D0.createDecipher = Z1;
D0.createDecipheriv = Zs;
var Ws = k0, Vs = D0, W1 = Cs;
function V1() {
...
var Js = Bc, N0 = Oe, Dr = q0, Ar = Ys, Gs = Jn;
function Y1(a, n) {
  a = a.toLowerCase();
  var o, s;
  if (Dr[a])
...
function Xs(a, n, o) {
  if (a = a.toLowerCase(), Dr[a])
    return N0.createCipheriv(a, n, o);
  if (Ar[a])
...
function js(a, n, o) {
  if (a = a.toLowerCase(), Dr[a])
    return N0.createDecipheriv(a, n, o);
  if (Ar[a])
    return new Js({ key: n, iv: o, mode: a, decrypt: !0 });
  throw new TypeError("invalid suite type");
}
function G1() {
  return Object.keys(Ar).concat(N0.getCiphers());
}
...
(function(a) {
  (function(n, o) {
    ...
    f.prototype.toString = function(t, r) {
      ...
      if (t === 16 || t === "hex") {
        ...
        for (var h = 0, d = 0, c = 0; c < this.length; c++) {
          ...
          d = v >>> 24 - h & 16777215, h += 2, h >= 26 && (h -= 26, c--), d !== 0 || c !== this.length - 1 ? i = w[6 - u.length] + u + i : i = u + i;
        }
      ...
      if (t === (t | 0) && t >= 2 && t <= 36) {
        ...
        for (b.negative = 0; !b.isZero(); ) {
          ...
          b = b.idivn(l), b.isZero() ? i = _ + i : i = w[e - _.length] + _ + i;
        }
    ...
    var U = function(t, r, i) {
      ...
      var Lt = (v + u | 0) + ((e & 8191) << 13) | 0;
      v = (l + (e >>> 13) | 0) + (Lt >>> 26) | 0, Lt &= 67108863, u = Math.imul(N, L), e = Math.imul(N, X), e = e + Math.imul(K, L) | 0, l = Math.imul(K, X), u = u + Math.imul(O, G) | 0, e = e + Math.imul(O, rt) | 0, e = e + Math.imul(R, G) | 0, l = l + Math.imul(R, rt) | 0, u = u + Math.imul(_, it) | 0, e = e + Math.imul(_, gt) | 0, e = e + Math.imul(C, it) | 0, l = l + Math.imul(C, gt) | 0;
      ...
      v = (l + (e >>> 13) | 0) + (ne >>> 26) | 0, ne &= 67108863, u = Math.imul(E, L), e = Math.imul(E, X), e = e + Math.imul(M, L) | 0, l = Math.imul(M, X), u = u + Math.imul(Q, G) | 0, e = e + Math.imul(Q, rt) | 0, e = e + Math.imul(ct, G) | 0, l = l + Math.imul(ct, rt) | 0, u = u + Math.imul(j, it) | 0, e = e + Math.imul(j, gt) | 0, e = e + Math.imul(dt, it) | 0, l = l + Math.imul(dt, gt) | 0, u = u + Math.imul(et, nt) | 0, e = e + Math.imul(et, bt) | 0, e = e + Math.imul(pt, nt) | 0, l = l + Math.imul(pt, bt) | 0, u = u + Math.imul(tt, ft) | 0, e = e + Math.imul(tt, yt) | 0, e = e + Math.imul(vt, ft) | 0, l = l + Math.imul(vt, yt) | 0, u = u + Math.imul(Z, at) | 0, e = e + Math.imul(Z, wt) | 0, e = e + Math.imul(J, at) | 0, l = l + Math.imul(J, wt) | 0, u = u + Math.imul(N, ht) | 0, e = e + Math.imul(N, Mt) | 0, e = e + Math.imul(K, ht) | 0, l = l + Math.imul(K, Mt) | 0, u = u + Math.imul(O, st) | 0, e = e + Math.imul(O, xt) | 0, e = e + Math.imul(R, st) | 0, l = l + Math.imul(R, xt) | 0, u = u + Math.imul(_, ot) | 0, e = e + Math.imul(_, _t) | 0, e = e + Math.imul(C, ot) | 0, l = l + Math.imul(C, _t) | 0;
      var fe = (v + u | 0) + ((e & 8191) << 13) | 0;
      v = (l + (e >>> 13) | 0) + (fe >>> 26) | 0, fe &= 67108863, u = Math.imul(T, L), e = Math.imul(T, X), e = e + Math.imul(F, L) | 0, l = Math.imul(F, X), u = u + Math.imul(E, G) | 0, e = e + Math.imul(E, rt) | 0, e = e + Math.imul(M, G) | 0, l = l + Math.imul(M, rt) | 0, u = u + Math.imul(Q, it) | 0, e = e + Math.imul(Q, gt) | 0, e = e + Math.imul(ct, it) | 0, l = l + Math.imul(ct, gt) | 0, u = u + Math.imul(j, nt) | 0, e = e + Math.imul(j, bt) | 0, e = e + Math.imul(dt, nt) | 0, l = l + Math.imul(dt, bt) | 0, u = u + Math.imul(et, ft) | 0, e = e + Math.imul(et, yt) | 0, e = e + Math.imul(pt, ft) | 0, l = l + Math.imul(pt, yt) | 0, u = u + Math.imul(tt, at) | 0, e = e + Math.imul(tt, wt) | 0, e = e + Math.imul(vt, at) | 0, l = l + Math.imul(vt, wt) | 0, u = u + Math.imul(Z, ht) | 0, e = e + Math.imul(Z, Mt) | 0, e = e + Math.imul(J, ht) | 0, l = l + Math.imul(J, Mt) | 0, u = u + Math.imul(N, st) | 0, e = e + Math.imul(N, xt) | 0, e = e + Math.imul(K, st) | 0, l = l + Math.imul(K, xt) | 0, u = u + Math.imul(O, ot) | 0, e = e + Math.imul(O, _t) | 0, e = e + Math.imul(R, ot) | 0, l = l + Math.imul(R, _t) | 0, u = u + Math.imul(_, ut) | 0, e = e + Math.imul(_, St) | 0, e = e + Math.imul(C, ut) | 0, l = l + Math.imul(C, St) | 0;
      var ae = (v + u | 0) + ((e & 8191) << 13) | 0;
      v = (l + (e >>> 13) | 0) + (ae >>> 26) | 0, ae &= 67108863, u = Math.imul(T, G), e = Math.imul(T, rt), e = e + Math.imul(F, G) | 0, l = Math.imul(F, rt), u = u + Math.imul(E, it) | 0, e = e + Math.imul(E, gt) | 0, e = e + Math.imul(M, it) | 0, l = l + Math.imul(M, gt) | 0, u = u + Math.imul(Q, nt) | 0, e = e + Math.imul(Q, bt) | 0, e = e + Math.imul(ct, nt) | 0, l = l + Math.imul(ct, bt) | 0, u = u + Math.imul(j, ft) | 0, e = e + Math.imul(j, yt) | 0, e = e + Math.imul(dt, ft) | 0, l = l + Math.imul(dt, yt) | 0, u = u + Math.imul(et, at) | 0, e = e + Math.imul(et, wt) | 0, e = e + Math.imul(pt, at) | 0, l = l + Math.imul(pt, wt) | 0, u = u + Math.imul(tt, ht) | 0, e = e + Math.imul(tt, Mt) | 0, e = e + Math.imul(vt, ht) | 0, l = l + Math.imul(vt, Mt) | 0, u = u + Math.imul(Z, st) | 0, e = e + Math.imul(Z, xt) | 0, e = e + Math.imul(J, st) | 0, l = l + Math.imul(J, xt) | 0, u = u + Math.imul(N, ot) | 0, e = e + Math.imul(N, _t) | 0, e = e + Math.imul(K, ot) | 0, l = l + Math.imul(K, _t) | 0, u = u + Math.imul(O, ut) | 0, e = e + Math.imul(O, St) | 0, e = e + Math.imul(R, ut) | 0, l = l + Math.imul(R, St) | 0;
      var he = (v + u | 0) + ((e & 8191) << 13) | 0;
      v = (l + (e >>> 13) | 0) + (he >>> 26) | 0, he &= 67108863, u = Math.imul(T, it), e = Math.imul(T, gt), e = e + Math.imul(F, it) | 0, l = Math.imul(F, gt), u = u + Math.imul(E, nt) | 0, e = e + Math.imul(E, bt) | 0, e = e + Math.imul(M, nt) | 0, l = l + Math.imul(M, bt) | 0, u = u + Math.imul(Q, ft) | 0, e = e + Math.imul(Q, yt) | 0, e = e + Math.imul(ct, ft) | 0, l = l + Math.imul(ct, yt) | 0, u = u + Math.imul(j, at) | 0, e = e + Math.imul(j, wt) | 0, e = e + Math.imul(dt, at) | 0, l = l + Math.imul(dt, wt) | 0, u = u + Math.imul(et, ht) | 0, e = e + Math.imul(et, Mt) | 0, e = e + Math.imul(pt, ht) | 0, l = l + Math.imul(pt, Mt) | 0, u = u + Math.imul(tt, st) | 0, e = e + Math.imul(tt, xt) | 0, e = e + Math.imul(vt, st) | 0, l = l + Math.imul(vt, xt) | 0, u = u + Math.imul(Z, ot) | 0, e = e + Math.imul(Z, _t) | 0, e = e + Math.imul(J, ot) | 0, l = l + Math.imul(J, _t) | 0, u = u + Math.imul(N, ut) | 0, e = e + Math.imul(N, St) | 0, e = e + Math.imul(K, ut) | 0, l = l + Math.imul(K, St) | 0;
      var se = (v + u | 0) + ((e & 8191) << 13) | 0;
      v = (l + (e >>> 13) | 0) + (se >>> 26) | 0, se &= 67108863, u = Math.imul(T, nt), e = Math.imul(T, bt), e = e + Math.imul(F, nt) | 0, l = Math.imul(F, bt), u = u + Math.imul(E, ft) | 0, e = e + Math.imul(E, yt) | 0, e = e + Math.imul(M, ft) | 0, l = l + Math.imul(M, yt) | 0, u = u + Math.imul(Q, at) | 0, e = e + Math.imul(Q, wt) | 0, e = e + Math.imul(ct, at) | 0, l = l + Math.imul(ct, wt) | 0, u = u + Math.imul(j, ht) | 0, e = e + Math.imul(j, Mt) | 0, e = e + Math.imul(dt, ht) | 0, l = l + Math.imul(dt, Mt) | 0, u = u + Math.imul(et, st) | 0, e = e + Math.imul(et, xt) | 0, e = e + Math.imul(pt, st) | 0, l = l + Math.imul(pt, xt) | 0, u = u + Math.imul(tt, ot) | 0, e = e + Math.imul(tt, _t) | 0, e = e + Math.imul(vt, ot) | 0, l = l + Math.imul(vt, _t) | 0, u = u + Math.imul(Z, ut) | 0, e = e + Math.imul(Z, St) | 0, e = e + Math.imul(J, ut) | 0, l = l + Math.imul(J, St) | 0;
      var oe = (v + u | 0) + ((e & 8191) << 13) | 0;
      v = (l + (e >>> 13) | 0) + (oe >>> 26) | 0, oe &= 67108863, u = Math.imul(T, ft), e = Math.imul(T, yt), e = e + Math.imul(F, ft) | 0, l = Math.imul(F, yt), u = u + Math.imul(E, at) | 0, e = e + Math.imul(E, wt) | 0, e = e + Math.imul(M, at) | 0, l = l + Math.imul(M, wt) | 0, u = u + Math.imul(Q, ht) | 0, e = e + Math.imul(Q, Mt) | 0, e = e + Math.imul(ct, ht) | 0, l = l + Math.imul(ct, Mt) | 0, u = u + Math.imul(j, st) | 0, e = e + Math.imul(j, xt) | 0, e = e + Math.imul(dt, st) | 0, l = l + Math.imul(dt, xt) | 0, u = u + Math.imul(et, ot) | 0, e = e + Math.imul(et, _t) | 0, e = e + Math.imul(pt, ot) | 0, l = l + Math.imul(pt, _t) | 0, u = u + Math.imul(tt, ut) | 0, e = e + Math.imul(tt, St) | 0, e = e + Math.imul(vt, ut) | 0, l = l + Math.imul(vt, St) | 0;
      var ue = (v + u | 0) + ((e & 8191) << 13) | 0;
      v = (l + (e >>> 13) | 0) + (ue >>> 26) | 0, ue &= 67108863, u = Math.imul(T, at), e = Math.imul(T, wt), e = e + Math.imul(F, at) | 0, l = Math.imul(F, wt), u = u + Math.imul(E, ht) | 0, e = e + Math.imul(E, Mt) | 0, e = e + Math.imul(M, ht) | 0, l = l + Math.imul(M, Mt) | 0, u = u + Math.imul(Q, st) | 0, e = e + Math.imul(Q, xt) | 0, e = e + Math.imul(ct, st) | 0, l = l + Math.imul(ct, xt) | 0, u = u + Math.imul(j, ot) | 0, e = e + Math.imul(j, _t) | 0, e = e + Math.imul(dt, ot) | 0, l = l + Math.imul(dt, _t) | 0, u = u + Math.imul(et, ut) | 0, e = e + Math.imul(et, St) | 0, e = e + Math.imul(pt, ut) | 0, l = l + Math.imul(pt, St) | 0;
      var le = (v + u | 0) + ((e & 8191) << 13) | 0;
      v = (l + (e >>> 13) | 0) + (le >>> 26) | 0, le &= 67108863, u = Math.imul(T, ht), e = Math.imul(T, Mt), e = e + Math.imul(F, ht) | 0, l = Math.imul(F, Mt), u = u + Math.imul(E, st) | 0, e = e + Math.imul(E, xt) | 0, e = e + Math.imul(M, st) | 0, l = l + Math.imul(M, xt) | 0, u = u + Math.imul(Q, ot) | 0, e = e + Math.imul(Q, _t) | 0, e = e + Math.imul(ct, ot) | 0, l = l + Math.imul(ct, _t) | 0, u = u + Math.imul(j, ut) | 0, e = e + Math.imul(j, St) | 0, e = e + Math.imul(dt, ut) | 0, l = l + Math.imul(dt, St) | 0;
      var de = (v + u | 0) + ((e & 8191) << 13) | 0;
      v = (l + (e >>> 13) | 0) + (de >>> 26) | 0, de &= 67108863, u = Math.imul(T, st), e = Math.imul(T, xt), e = e + Math.imul(F, st) | 0, l = Math.imul(F, xt), u = u + Math.imul(E, ot) | 0, e = e + Math.imul(E, _t) | 0, e = e + Math.imul(M, ot) | 0, l = l + Math.imul(M, _t) | 0, u = u + Math.imul(Q, ut) | 0, e = e + Math.imul(Q, St) | 0, e = e + Math.imul(ct, ut) | 0, l = l + Math.imul(ct, St) | 0;
      var ce = (v + u | 0) + ((e & 8191) << 13) | 0;
      v = (l + (e >>> 13) | 0) + (ce >>> 26) | 0, ce &= 67108863, u = Math.imul(T, ot), e = Math.imul(T, _t), e = e + Math.imul(F, ot) | 0, l = Math.imul(F, _t), u = u + Math.imul(E, ut) | 0, e = e + Math.imul(E, St) | 0, e = e + Math.imul(M, ut) | 0, l = l + Math.imul(M, St) | 0;
      ...
      return v = (l + (e >>> 13) | 0) + (pe >>> 26) | 0, pe &= 67108863, c[0] = $t, c[1] = Lt, c[2] = Qt, c[3] = te, c[4] = ee, c[5] = re, c[6] = ie, c[7] = ne, c[8] = fe, c[9] = ae, c[10] = he, c[11] = se, c[12] = oe, c[13] = ue, c[14] = le, c[15] = de, c[16] = ce, c[17] = ve, c[18] = pe, v !== 0 && (c[19] = v, i.length++), i;
    };
    Math.imul || (U = D);
    function W(p, t, r) {
...
var X1 = L0.exports, dn = { exports: {} }, Ia;
function U0() {
  if (Ia)
    return dn.exports;
  Ia = 1;
...
function to() {
  ...
  return Sf = o, o.create = function(m) {
    return new o(m);
    ...
    for (var w = m.subn(1), x = 0; !w.testn(x); x++)
      ;
    for (var I = m.shrn(x), k = w.toRed(S), D = !0; f > 0; f--) {
      var U = this._randrange(new a(2), w);
      g && g(U);
    ...
    for (var B = m.subn(1), w = 0; !B.testn(w); w++)
      ;
    for (var x = m.shrn(w), I = B.toRed(y); f > 0; f--) {
...
function hv() {
  ...
  function D(W, z, $) {
    this.setGenerator(z), this.__prime = new a(W), this._prime = a.mont(this.__prime), this._primeLen = W.length, this._pub = void 0, this._priv = void 0, this._primeCode = void 0, $ ? (this.setPublicKey = w, this.setPrivateKey = x) : this._primeCode = 8;
  }
...
var d0 = { exports: {} }, c0 = { exports: {} };
typeof we == "undefined" || !we.version || we.version.indexOf("v0.") === 0 || we.version.indexOf("v1.") === 0 && we.version.indexOf("v1.8.") !== 0 ? c0.exports = { nextTick: ov } : c0.exports = we;
function ov(a, n, o, s) {
...
var jn = c0.exports, uv = {}.toString, lv = Array.isArray || function(a) {
  return uv.call(a) == "[object Array]";
}, ro = Ne.EventEmitter, v0 = { exports: {} };
(function(a, n) {
  var o = br, s = o.Buffer;
  function m(g, y) {
    for (var S in g)
...
var O0 = v0.exports, Me = {};
function dv(a) {
  return Array.isArray ? Array.isArray(a) : Qn(a) === "[object Array]";
}
Me.isArray = dv;
function cv(a) {
...
Me.isObject = Mv;
function xv(a) {
  return Qn(a) === "[object Date]";
}
Me.isDate = xv;
function _v(a) {
  return Qn(a) === "[object Error]" || a instanceof Error;
}
Me.isError = _v;
function Sv(a) {
  ...
  return qa || (qa = 1, function(a) {
    ...
    a.exports = function() {
      ...
      return f.prototype.push = function(y) {
        ...
        if (this.length === 0)
          return o.alloc(0);
        for (var S = o.allocUnsafe(y >>> 0), B = this.head, w = 0; B; )
          m(B.data, S, w), w += B.data.length, B = B.next;
        return S;
      }, f;
...
function Rv(a, n) {
  ...
  function s() {
    if (!o) {
      if (kf("throwDeprecation"))
        throw new Error(n);
      kf("traceDeprecation") ? console.trace(n) : console.warn(n), o = !0;
    }
...
function no() {
  ...
  var f = {
    deprecate: Iv
  }, g = ro, y = O0.Buffer, S = (typeof Xt != "undefined" ? Xt : typeof window != "undefined" ? window : typeof self != "undefined" ? self : {}).Uint8Array || function() {
  };
  function B(c) {
    return y.from(c);
  }
  ...
  U.prototype.write = function(c, v, u) {
    var e = this._writableState, l = !1, b = !e.objectMode && w(c);
...
function ci() {
  if (Da)
    return Rf;
  Da = 1;
  var a = jn, n = Object.keys || function(x) {
    var I = [];
    for (var k in x)
      I.push(k);
    return I;
  ...
  function B() {
    this.allowHalfOpen || this._writableState.ended || a.nextTick(w, this);
  }
  function w(x) {
    x.end();
  }
...
function fo() {
  ...
  }, m = ro, f = O0.Buffer, g = (typeof Xt != "undefined" ? Xt : typeof window != "undefined" ? window : typeof self != "undefined" ? self : {}).Uint8Array || function() {
  };
  function y(R) {
    return f.from(R);
  }
  ...
  B.inherits = Gt;
  var w = Ne, x = void 0;
  w && w.debuglog ? x = w.debuglog("stream") : x = function() {
  };
  var I = Bv(), k = io, D;
  B.inherits($, m);
  ...
  $.prototype._read = function(R) {
    ...
    function Dt(Q) {
      x("onerror", Q), Pt(), R.removeListener("error", Dt), s(R, "error") === 0 && R.emit("error", Q);
    }
    W(R, "error", Dt);
    function j() {
      R.removeListener("finish", dt), Pt();
    }
    R.once("close", j);
    function dt() {
      x("onfinish"), R.removeListener("close", j), Pt();
    }
    R.once("finish", dt);
    function Pt() {
      x("unpipe"), N.unpipe(R);
...
var ao = Er, tf = ci(), ho = Object.create(Me);
ho.inherits = Gt;
ho.inherits(Er, tf);
function Tv(a, n) {
...
function Er(a) {
  if (!(this instanceof Er))
    return new Er(a);
  tf.call(this, a), this._transformState = {
...
Er.prototype.push = function(a, n) {
  return this._transformState.needTransform = !1, tf.prototype.push.call(this, a, n);
};
...
Er.prototype._destroy = function(a, n) {
  var o = this;
  tf.prototype._destroy.call(this, a, function(s) {
    n(s), o.emit("close");
  });
};
function $a(a, n, o) {
...
var qv = d0.exports, Pi = { exports: {} }, z0 = { exports: {} };
z0.exports;
(function(a) {
  (function(n, o) {
    function s(r, i) {
    ...
    var $ = function(i, h, d) {
      ...
      e = (_ + (b >>> 13) | 0) + (de >>> 26) | 0, de &= 67108863, l = Math.imul(V, Wt), b = Math.imul(V, ht), b = b + Math.imul(L, Wt) | 0, _ = Math.imul(L, ht), l = l + Math.imul(A, Vt) | 0, b = b + Math.imul(A, st) | 0, b = b + Math.imul(T, Vt) | 0, _ = _ + Math.imul(T, st) | 0, l = l + Math.imul(Ot, Yt) | 0, b = b + Math.imul(Ot, ot) | 0, b = b + Math.imul(E, Yt) | 0, _ = _ + Math.imul(E, ot) | 0, l = l + Math.imul(Pt, Jt) | 0, b = b + Math.imul(Pt, ut) | 0, b = b + Math.imul(Q, Jt) | 0, _ = _ + Math.imul(Q, ut) | 0, l = l + Math.imul(Dt, $t) | 0, b = b + Math.imul(Dt, Lt) | 0, b = b + Math.imul(j, $t) | 0, _ = _ + Math.imul(j, Lt) | 0;
      var ce = (e + l | 0) + ((b & 8191) << 13) | 0;
      e = (_ + (b >>> 13) | 0) + (ce >>> 26) | 0, ce &= 67108863, l = Math.imul(V, Vt), b = Math.imul(V, st), b = b + Math.imul(L, Vt) | 0, _ = Math.imul(L, st), l = l + Math.imul(A, Yt) | 0, b = b + Math.imul(A, ot) | 0, b = b + Math.imul(T, Yt) | 0, _ = _ + Math.imul(T, ot) | 0, l = l + Math.imul(Ot, Jt) | 0, b = b + Math.imul(Ot, ut) | 0, b = b + Math.imul(E, Jt) | 0, _ = _ + Math.imul(E, ut) | 0, l = l + Math.imul(Pt, $t) | 0, b = b + Math.imul(Pt, Lt) | 0, b = b + Math.imul(Q, $t) | 0, _ = _ + Math.imul(Q, Lt) | 0;
      var ve = (e + l | 0) + ((b & 8191) << 13) | 0;
      e = (_ + (b >>> 13) | 0) + (ve >>> 26) | 0, ve &= 67108863, l = Math.imul(V, Yt), b = Math.imul(V, ot), b = b + Math.imul(L, Yt) | 0, _ = Math.imul(L, ot), l = l + Math.imul(A, Jt) | 0, b = b + Math.imul(A, ut) | 0, b = b + Math.imul(T, Jt) | 0, _ = _ + Math.imul(T, ut) | 0, l = l + Math.imul(Ot, $t) | 0, b = b + Math.imul(Ot, Lt) | 0, b = b + Math.imul(E, $t) | 0, _ = _ + Math.imul(E, Lt) | 0;
      var pe = (e + l | 0) + ((b & 8191) << 13) | 0;
      e = (_ + (b >>> 13) | 0) + (pe >>> 26) | 0, pe &= 67108863, l = Math.imul(V, Jt), b = Math.imul(V, ut), b = b + Math.imul(L, Jt) | 0, _ = Math.imul(L, ut), l = l + Math.imul(A, $t) | 0, b = b + Math.imul(A, Lt) | 0, b = b + Math.imul(T, $t) | 0, _ = _ + Math.imul(T, Lt) | 0;
      var df = (e + l | 0) + ((b & 8191) << 13) | 0;
      e = (_ + (b >>> 13) | 0) + (df >>> 26) | 0, df &= 67108863, l = Math.imul(V, $t), b = Math.imul(V, Lt), b = b + Math.imul(L, $t) | 0, _ = Math.imul(L, Lt);
      var cf = (e + l | 0) + ((b & 8191) << 13) | 0;
      return e = (_ + (b >>> 13) | 0) + (cf >>> 26) | 0, cf &= 67108863, u[0] = Qt, u[1] = te, u[2] = ee, u[3] = re, u[4] = ie, u[5] = ne, u[6] = fe, u[7] = ae, u[8] = he, u[9] = se, u[10] = oe, u[11] = ue, u[12] = le, u[13] = de, u[14] = ce, u[15] = ve, u[16] = pe, u[17] = df, u[18] = cf, e !== 0 && (u[19] = e, d.length++), d;
    };
    Math.imul || ($ = z);
    function lt(r, i, h) {
    ...
    p.prototype._verify1 = function(i) {
      ...
      return this.prime ? this.prime.ireduce(i)._forceRed(this) : (w(i, i.umod(this.m)._forceRed(this)), i);
...
var K0 = z0.exports, ui = K0, Pv = yi, Dv = zt.Buffer;
function uo(a) {
...
function lo(a, n) {
  var o = Nv(n), s = n.modulus.byteLength(), m = new ui(a).mul(o.blinder).umod(n.modulus), f = m.toRed(ui.mont(n.prime1)), g = m.toRed(ui.mont(n.prime2)), y = n.coefficient, S = n.prime1, B = n.prime2, w = f.redPow(n.exponent1).fromRed(), x = g.redPow(n.exponent2).fromRed(), I = w.isub(x).imul(y).umod(S).imul(B);
...
(function(a) {
  ...
  function o(f, g) {
    ...
    if (g === "hex") {
      ...
      for (var S = 0; S < f.length; S++) {
        var B = f.charCodeAt(S), w = B >> 8, x = B & 255;
        w ? y.push(w, x) : y.push(x);
      }
    return y;
  }
  n.toArray = o;
...
(function(a) {
  ...
  function g(w, x) {
    ...
    w = w.clone(), x = x.clone();
    for (var k = 0, D = 0, U; w.cmpn(-k) > 0 || x.cmpn(-D) > 0; ) {
      var W = w.andln(3) + k & 3, z = x.andln(3) + D & 3;
      W === 3 && (W = -1), z === 3 && (z = -1);
      var $;
      W & 1 ? (U = w.andln(7) + k & 7, (U === 3 || U === 5) && z === 2 ? $ = -W : $ = W) : $ = 0, I[0].push($);
      var lt;
      z & 1 ? (U = x.andln(7) + D & 7, (U === 3 || U === 5) && W === 2 ? lt = -z : lt = z) : lt = 0, I[1].push(lt), 2 * k === $ + 1 && (k = 1 - k), 2 * D === lt + 1 && (D = 1 - D), w.iushrn(1), x.iushrn(1);
    }
    return I;
  }
  n.getJSF = g;
...
var V0 = {}, Hr = Tr, an = Ke, In = an.getNAF, Qv = an.getJSF, Rn = an.assert;
function Ur(a, n) {
...
Ur.prototype._fixedNafMul = function(n, o) {
  ...
  for (var w = this.jpoint(null, null, null), x = this.jpoint(null, null, null), I = f; I > 0; I--) {
...
Ur.prototype._wnafMul = function(n, o) {
  ...
  for (var f = m.points, g = In(o, s, this._bitLength), y = this.jpoint(null, null, null), S = g.length - 1; S >= 0; S--) {
    ...
    if (S >= 0 && B++, y = y.dblp(B), S < 0)
      break;
    var w = g[S];
    Rn(w !== 0), n.type === "affine" ? w > 0 ? y = y.mixedAdd(f[w - 1 >> 1]) : y = y.mixedAdd(f[-w - 1 >> 1].neg()) : w > 0 ? y = y.add(f[w - 1 >> 1]) : y = y.add(f[-w - 1 >> 1].neg());
  }
  return n.type === "affine" ? y.toP() : y;
};
Ur.prototype._wnafMulAdd = function(n, o, s, m, f) {
  var g = this._wnafT1, y = this._wnafT2, S = this._wnafT3, B = 0, w, x, I;
  for (w = 0; w < m; w++) {
    I = o[w];
    var k = I._getNAFPoints(n);
    g[w] = k.wnd, y[w] = k.points;
  }
  for (w = m - 1; w >= 1; w -= 2) {
    var D = w - 1, U = w;
    if (g[D] !== 1 || g[U] !== 1) {
  ...
  for (w = B; w >= 0; w--) {
    for (var Ct = 0; w >= 0; ) {
      var Et = !0;
      for (x = 0; x < m; x++)
        Bt[x] = S[x][w] | 0, Bt[x] !== 0 && (Et = !1);
      if (!Et)
        break;
      Ct++, w--;
    }
    if (w >= 0 && Ct++, At = At.dblp(Ct), w < 0)
      break;
    for (x = 0; x < m; x++) {
      var Y = Bt[x];
...
var tp = Ke, be = Tr, Y0 = Gt, xi = ef, ep = tp.assert;
function Ge(a) {
...
Ge.prototype._getEndoBasis = function(n) {
  for (var o = this.n.ushrn(Math.floor(this.n.bitLength() / 2)), s = n, m = this.n.clone(), f = new be(1), g = new be(0), y = new be(0), S = new be(1), B, w, x, I, k, D, U, W = 0, z, $; s.cmpn(0) !== 0; ) {
    var lt = m.div(s);
    z = m.sub(lt.mul(s)), $ = y.sub(lt.mul(f));
    var H = S.sub(lt.mul(g));
    if (!x && z.cmp(o) < 0)
      B = U.neg(), w = f, x = z.neg(), I = $;
    else if (x && ++W === 2)
      break;
  ...
  return Bt.cmp(At) >= 0 && (k = B, D = w), x.negative && (x = x.neg(), I = I.neg()), k.negative && (k = k.neg(), D = D.neg()), [
    { a: x, b: I },
    { a: k, b: D }
  ];
};
Ge.prototype._endoSplit = function(n) {
  var o = this.endo.basis, s = o[0], m = o[1], f = m.b.mul(n).divRound(this.n), g = s.b.neg().mul(n).divRound(this.n), y = f.mul(s.a), S = g.mul(m.a), B = f.mul(s.b), w = g.mul(m.b), x = n.sub(y).sub(S), I = B.add(w).neg();
  return { k1: x, k2: I };
};
...
Ge.prototype._endoWnafMulAdd = function(n, o, s) {
  ...
  for (var w = this._wnafMulAdd(1, m, f, g * 2, s), x = 0; x < g * 2; x++)
    m[x] = null, f[x] = null;
  return w;
};
function Ee(a, n, o, s) {
...
ke.prototype.add = function(n) {
  ...
  var w = S.redSqr(), x = w.redMul(S), I = m.redMul(w), k = B.redSqr().redIAdd(x).redISub(I).redISub(I), D = B.redMul(I.redISub(k)).redISub(g.redMul(x)), U = this.z.redMul(n.z).redMul(S);
...
ke.prototype.mixedAdd = function(n) {
  ...
  var B = y.redSqr(), w = B.redMul(y), x = s.redMul(B), I = S.redSqr().redIAdd(w).redISub(x).redISub(x), k = S.redMul(x.redISub(I)).redISub(f.redMul(w)), D = this.z.redMul(y);
...
ke.prototype.dblp = function(n) {
  ...
  var m = this.curve.a, f = this.curve.tinv, g = this.x, y = this.y, S = this.z, B = S.redSqr().redSqr(), w = y.redAdd(y);
  for (o = 0; o < n; o++) {
    var x = g.redSqr(), I = w.redSqr(), k = I.redSqr(), D = x.redAdd(x).redIAdd(x).redIAdd(m.redMul(B)), U = g.redMul(I), W = D.redSqr().redISub(U.redAdd(U)), z = U.redISub(W), $ = D.redMul(z);
    $ = $.redIAdd($).redISub(k);
    var lt = w.redMul(S);
    o + 1 < n && (B = B.redMul(k)), g = W, S = lt, w = $;
  }
  return this.curve.jpoint(g, w.redMul(f), S);
};
...
ke.prototype._zeroDbl = function() {
  ...
  if (this.zOne) {
    ...
    y = y.redIAdd(y);
    var S = m.redAdd(m).redIAdd(m), B = S.redSqr().redISub(y).redISub(y), w = g.redIAdd(g);
    w = w.redIAdd(w), w = w.redIAdd(w), n = B, o = S.redMul(y.redISub(B)).redISub(w), s = this.y.redAdd(this.y);
  } else {
...
ke.prototype._threeDbl = function() {
  ...
  if (this.zOne) {
    ...
    n = B;
    var w = g.redIAdd(g);
    w = w.redIAdd(w), w = w.redIAdd(w), o = S.redMul(y.redISub(B)).redISub(w), s = this.y.redAdd(this.y);
  } else {
...
ke.prototype._dbl = function() {
  ...
  B = B.redIAdd(B);
  var w = B.redMul(y), x = S.redSqr().redISub(w.redAdd(w)), I = w.redISub(x), k = y.redSqr();
...
ke.prototype.trpl = function() {
  ...
  var w = f.redIAdd(y).redSqr().redISub(g).redISub(S).redISub(B), x = o.redMul(w);
  x = x.redIAdd(x), x = x.redIAdd(x);
  var I = this.x.redMul(S).redISub(x);
  I = I.redIAdd(I), I = I.redIAdd(I);
  var k = this.y.redMul(w.redMul(B.redISub(w)).redISub(y.redMul(S)));
  k = k.redIAdd(k), k = k.redIAdd(k), k = k.redIAdd(k);
...
var si = Tr, co = Gt, rf = ef, ip = Ke;
function _i(a) {
  rf.call(this, "mont", a), this.a = new si(a.a, 16).toRed(this.red), this.b = new si(a.b, 16).toRed(this.red), this.i4 = new si(4).toRed(this.red).redInvm(), this.two = new si(2).toRed(this.red), this.a24 = this.i4.redMul(this.a.redAdd(this.two));
}
co(_i, rf);
var np = _i;
...
function Ae(a, n, o) {
  rf.BasePoint.call(this, a, "projective"), n === null && o === null ? (this.x = this.curve.one, this.z = this.curve.zero) : (this.x = new si(n, 16), this.z = new si(o, 16), this.x.red || (this.x = this.x.toRed(this.curve.red)), this.z.red || (this.z = this.z.toRed(this.curve.red)));
}
co(Ae, rf.BasePoint);
...
Ae.prototype.diffAdd = function(n, o) {
  var s = this.x.redAdd(this.z), m = this.x.redSub(this.z), f = n.x.redAdd(n.z), g = n.x.redSub(n.z), y = g.redMul(s), S = f.redMul(m), B = o.z.redMul(y.redAdd(S).redSqr()), w = o.x.redMul(y.redISub(S).redSqr());
...
var fp = Ke, Sr = Tr, vo = Gt, nf = ef, ap = fp.assert;
function yr(a) {
  this.twisted = (a.a | 0) !== 1, this.mOneA = this.twisted && (a.a | 0) === -1, this.extended = this.mOneA, nf.call(this, "edwards", a), this.a = new Sr(a.a, 16).umod(this.red.m), this.a = this.a.toRed(this.red), this.c = new Sr(a.c, 16).toRed(this.red), this.c2 = this.c.redSqr(), this.d = new Sr(a.d, 16).toRed(this.red), this.dd = this.d.redAdd(this.d), ap(!this.twisted || this.c.fromRed().cmpn(1) === 0), this.oneC = (a.c | 0) === 1;
}
vo(yr, nf);
var hp = yr;
...
ge.prototype._extDbl = function() {
  ...
  s = s.redIAdd(s);
  var m = this.curve._mulA(n), f = this.x.redAdd(this.y).redSqr().redISub(n).redISub(o), g = m.redAdd(o), y = g.redSub(s), S = m.redSub(o), B = f.redMul(y), w = g.redMul(S), x = f.redMul(S), I = y.redMul(g);
  return this.curve.point(B, w, I, x);
};
ge.prototype._projDbl = function() {
  ...
  if (this.curve.twisted) {
    ...
    var w = y.redAdd(s);
    this.zOne ? (m = n.redSub(o).redSub(s).redMul(w.redSub(this.curve.two)), f = w.redMul(y.redSub(s)), g = w.redSqr().redSub(w).redSub(w)) : (S = this.z.redSqr(), B = w.redSub(S).redISub(S), m = n.redSub(o).redISub(s).redMul(B), f = w.redMul(y.redSub(s)), g = w.redMul(B));
  } else
...
ge.prototype._extAdd = function(n) {
  var o = this.y.redSub(this.x).redMul(n.y.redSub(n.x)), s = this.y.redAdd(this.x).redMul(n.y.redAdd(n.x)), m = this.t.redMul(this.curve.dd).redMul(n.t), f = this.z.redMul(n.z.redAdd(n.z)), g = s.redSub(o), y = f.redSub(m), S = f.redAdd(m), B = s.redAdd(o), w = g.redMul(y), x = S.redMul(B), I = g.redMul(B), k = y.redMul(S);
  return this.curve.point(w, x, k, I);
};
ge.prototype._projAdd = function(n) {
  var o = this.z.redMul(n.z), s = o.redSqr(), m = this.x.redMul(n.x), f = this.y.redMul(n.y), g = this.curve.d.redMul(m).redMul(f), y = s.redSub(g), S = s.redAdd(g), B = this.x.redAdd(this.y).redMul(n.x.redAdd(n.y)).redISub(m).redISub(f), w = o.redMul(y).redMul(B), x, I;
  return this.curve.twisted ? (x = o.redMul(S).redMul(f.redSub(this.curve._mulA(m))), I = y.redMul(S)) : (x = o.redMul(S).redMul(f.redSub(m)), I = this.curve._mulC(y).redMul(S)), this.curve.point(w, x, I);
};
...
(function(a) {
  var n = a;
  n.base = ef, n.short = rp, n.mont = np, n.edwards = hp;
})(V0);
var ff = {}, af = {}, jt = {}, sp = Ve, op = Gt;
jt.inherits = op;
function up(a, n) {
...
function Ep(a, n, o, s, m, f, g, y, S, B) {
  var w = 0, x = n;
  x = x + s >>> 0, w += x < n ? 1 : 0, x = x + f >>> 0, w += x < f ? 1 : 0, x = x + y >>> 0, w += x < y ? 1 : 0, x = x + B >>> 0, w += x < B ? 1 : 0;
  var I = a + o + m + g + S + w;
  return I >>> 0;
}
jt.sum64_5_hi = Ep;
...
Si.BlockHash = hf;
hf.prototype.update = function(n, o) {
...
wr.g1_256 = Lp;
var vi = jt, Up = Si, Op = wr, Ff = vi.rotl32, Di = vi.sum32, zp = vi.sum32_5, Kp = Op.ft_1, Mo = Up.BlockHash, Hp = [
  1518500249,
  1859775393,
  2400959708,
  3395469782
...
pr.prototype._update = function(n, o) {
  for (var s = this.W, m = 0; m < 16; m++)
    s[m] = n[o + m];
  for (; m < s.length; m++)
    s[m] = Ff(s[m - 3] ^ s[m - 8] ^ s[m - 14] ^ s[m - 16], 1);
  var f = this.h[0], g = this.h[1], y = this.h[2], S = this.h[3], B = this.h[4];
  for (m = 0; m < s.length; m++) {
    var w = ~~(m / 20), x = zp(Ff(f, 5), Kp(w, g, y, S), B, s[m], Hp[w]);
    B = S, S = y, y = Ff(g, 30), g = f, f = x;
  }
...
mr.prototype._update = function(n, o) {
  ...
  var f = this.h[0], g = this.h[1], y = this.h[2], S = this.h[3], B = this.h[4], w = this.h[5], x = this.h[6], I = this.h[7];
  for (Vp(this.k.length === s.length), m = 0; m < s.length; m++) {
    var k = Jp(I, Qp(B), Gp(B, w, x), this.k[m], s[m]), D = je(jp(f), Xp(f, g, y));
    I = x, x = w, w = B, B = je(S, k), S = y, y = g, g = f, f = je(k, D);
  }
  this.h[0] = je(this.h[0], f), this.h[1] = je(this.h[1], g), this.h[2] = je(this.h[2], y), this.h[3] = je(this.h[3], S), this.h[4] = je(this.h[4], B), this.h[5] = je(this.h[5], w), this.h[6] = je(this.h[6], x), this.h[7] = je(this.h[7], I);
};
...
kr.prototype._digest = function(n) {
  return n === "hex" ? p0.toHex32(this.h.slice(0, 7), "big") : p0.split32(this.h.slice(0, 7), "big");
};
var $e = jt, nm = Si, fm = Ve, lr = $e.rotr64_hi, dr = $e.rotr64_lo, Ao = $e.shr64_hi, Bo = $e.shr64_lo, Cr = $e.sum64, qf = $e.sum64_hi, Pf = $e.sum64_lo, am = $e.sum64_4_hi, hm = $e.sum64_4_lo, sm = $e.sum64_5_hi, om = $e.sum64_5_lo, Eo = nm.BlockHash, um = [
  1116352408,
  3609767458,
  1899447441,
  602891725,
...
er.prototype._prepareBlock = function(n, o) {
  for (var s = this.W, m = 0; m < 32; m++)
    s[m] = n[o + m];
  for (; m < s.length; m += 2) {
    var f = Mm(s[m - 4], s[m - 3]), g = xm(s[m - 4], s[m - 3]), y = s[m - 14], S = s[m - 13], B = ym(s[m - 30], s[m - 29]), w = wm(s[m - 30], s[m - 29]), x = s[m - 32], I = s[m - 31];
    s[m] = am(
      f,
      g,
      y,
...
er.prototype._update = function(n, o) {
  ...
  var s = this.W, m = this.h[0], f = this.h[1], g = this.h[2], y = this.h[3], S = this.h[4], B = this.h[5], w = this.h[6], x = this.h[7], I = this.h[8], k = this.h[9], D = this.h[10], U = this.h[11], W = this.h[12], z = this.h[13], $ = this.h[14], lt = this.h[15];
  ...
  for (var H = 0; H < s.length; H += 2) {
    ...
    var c = qf(At, Bt, Ct, Et), v = Pf(At, Bt, Ct, Et);
    $ = W, lt = z, W = D, z = U, D = I, U = k, I = qf(w, x, h, d), k = Pf(x, x, h, d), w = S, x = B, S = g, B = y, g = m, y = f, m = qf(h, d, c, v), f = Pf(h, d, c, v);
  }
  Cr(this.h, 0, m, f), Cr(this.h, 2, g, y), Cr(this.h, 4, S, B), Cr(this.h, 6, w, x), Cr(this.h, 8, I, k), Cr(this.h, 10, D, U), Cr(this.h, 12, W, z), Cr(this.h, 14, $, lt);
};
...
Ir.prototype._digest = function(n) {
  return n === "hex" ? m0.toHex32(this.h.slice(0, 12), "big") : m0.split32(this.h.slice(0, 12), "big");
};
Ai.sha1 = Zp;
Ai.sha224 = im;
Ai.sha256 = _o;
...
gr.prototype._update = function(n, o) {
  for (var s = this.h[0], m = this.h[1], f = this.h[2], g = this.h[3], y = this.h[4], S = s, B = m, w = f, x = g, I = y, k = 0; k < 80; k++) {
    var D = Ua(
      pn(
    ...
    s = y, y = g, g = pn(f, 10), f = m, m = D, D = Ua(
      pn(
        Oa(S, za(79 - k, B, w, x), n[km[k] + o], Bm(k)),
        Rm[k]
      ),
      I
    ), S = I, I = x, x = pn(w, 10), w = B, B = D;
  }
  D = Ni(this.h[1], f, x), this.h[1] = Ni(this.h[2], g, I), this.h[2] = Ni(this.h[3], y, S), this.h[3] = Ni(this.h[4], s, B), this.h[4] = Ni(this.h[0], m, w), this.h[0] = D;
};
...
(function(a) {
  var n = a, o = af, s = V0, m = Ke, f = m.assert;
  function g(B) {
...
qe.prototype._importPublic = function(n, o) {
  if (n.x || n.y) {
    this.ec.curve.type === "mont" ? g0(n.x, "Need x coordinate") : (this.ec.curve.type === "short" || this.ec.curve.type === "edwards") && g0(n.x && n.y, "Need both x and y coordinate"), this.pub = this.ec.curve.point(n.x, n.y);
    return;
  }
  this.pub = this.ec.curve.decodePoint(n, o);
};
qe.prototype.derive = function(n) {
  return n.validate() || g0(n.validate(), "public point not validated"), n.mul(this.priv).getX();
};
...
sf.prototype._importDER = function(n, o) {
  n = J0.toArray(n, o);
  var s = new zm();
  if (n[s.place++] !== 48)
    return !1;
...
function Km() {
  if (Za)
    return Lf;
  Za = 1;
  var a = Tr, n = Dm, o = Ke, s = ff, m = U0(), f = o.assert, g = Lm, y = Om;
  function S(B) {
    if (!(this instanceof S))
      return new S(B);
    typeof B == "string" && (f(
  ...
  return Lf = S, S.prototype.keyPair = function(w) {
    return new g(this, w);
  }, S.prototype.keyFromPrivate = function(w, x) {
    return g.fromPrivate(this, w, x);
  }, S.prototype.keyFromPublic = function(w, x) {
    return g.fromPublic(this, w, x);
  }, S.prototype.genKeyPair = function(w) {
    w || (w = {});
    for (var x = new n({
      hash: this.hash,
      pers: w.pers,
      persEnc: w.persEnc || "utf8",
      entropy: w.entropy || m(this.hash.hmacStrength),
      entropyEnc: w.entropy && w.entropyEnc || "utf8",
  ...
  }, S.prototype._truncateToN = function(w, x, I) {
    var k;
    if (a.isBN(w) || typeof w == "number")
      w = new a(w, 16), k = w.byteLength();
    else if (typeof w == "object")
      k = w.length, w = new a(w, 16);
    else {
      var D = w.toString();
      k = D.length + 1 >>> 1, w = new a(D, 16);
    }
    typeof I != "number" && (I = k * 8);
    var U = I - this.n.bitLength();
    return U > 0 && (w = w.ushrn(U)), !x && w.cmp(this.n) >= 0 ? w.sub(this.n) : w;
  }, S.prototype.sign = function(w, x, I, k) {
    if (typeof I == "object" && (k = I, I = null), k || (k = {}), typeof w != "string" && typeof w != "number" && !a.isBN(w)) {
      f(
        typeof w == "object" && w && typeof w.length == "number",
        "Expected message to be an array-like, a hex string, or a BN instance"
      ), f(w.length >>> 0 === w.length);
      for (var D = 0; D < w.length; D++)
        f((w[D] & 255) === w[D]);
    }
    x = this.keyFromPrivate(x, I), w = this._truncateToN(w, !1, k.msgBitLength), f(!w.isNeg(), "Can not sign a negative message");
    var U = this.n.byteLength(), W = x.getPrivate().toArray("be", U), z = w.toArray("be", U);
    f(new a(z).eq(w), "Can not sign message");
    for (var $ = new n({
      hash: this.hash,
      entropy: W,
      nonce: z,
      ...
      if (At = this._truncateToN(At, !0), !(At.cmpn(1) <= 0 || At.cmp(lt) >= 0)) {
        ...
        if (!Bt.isInfinity()) {
          ...
          if (Et.cmpn(0) !== 0) {
            var Y = At.invm(this.n).mul(Et.mul(x.getPrivate()).iadd(w));
  ...
  }, S.prototype.verify = function(w, x, I, k, D) {
    D || (D = {}), w = this._truncateToN(w, !1, D.msgBitLength), I = this.keyFromPublic(I, k), x = new y(x, "hex");
    var U = x.r, W = x.s;
    if (U.cmpn(1) < 0 || U.cmp(this.n) >= 0 || W.cmpn(1) < 0 || W.cmp(this.n) >= 0)
      return !1;
    var z = W.invm(this.n), $ = z.mul(w).umod(this.n), lt = z.mul(U).umod(this.n), H;
  ...
  }, S.prototype.recoverPubKey = function(B, w, x, I) {
    f((3 & x) === x, "The recovery param is more than two bits"), w = new y(w, I);
    var k = this.n, D = new a(B), U = w.r, W = w.s, z = x & 1, $ = x >> 1;
    ...
    var lt = w.r.invm(k), H = k.sub(D).mul(lt).umod(k), At = W.mul(lt).umod(k);
    return this.g.mulAdd(H, U, At);
  }, S.prototype.getKeyRecoveryParam = function(B, w, x, I) {
    if (w = new y(w, I), w.recoveryParam !== null)
      return w.recoveryParam;
    for (var k = 0; k < 4; k++) {
      var D;
      try {
        D = this.recoverPubKey(B, w, k);
      } catch (U) {
        continue;
      }
      if (D.eq(x))
...
var Hm = Se, Zm = Tr, of = Ke, Va = of.assert, uf = of.cachedProperty, Wm = of.parseBytes;
function ii(a, n) {
...
uf(ii, "Rencoded", function() {
  return this.eddsa.encodePoint(this.R());
});
uf(ii, "Sencoded", function() {
...
ii.prototype.toHex = function() {
  return of.encode(this.toBytes(), "hex").toUpperCase();
};
var Vm = ii, Ym = af, Jm = ff, gi = Ke, Gm = gi.assert, qo = gi.parseBytes, Po = Hm, Ya = Vm;
function Le(a) {
...
function G0() {
  return Ja || (Ja = 1, function(a) {
    var n = a;
    n.version = jv.version, n.utils = Ke, n.rand = U0(), n.curve = V0, n.curves = ff, n.ec = Km(), n.eddsa = Xm;
  }(Cf)), Cf;
}
var ir = {}, Uf = {}, X0 = { exports: {} };
X0.exports;
(function(a) {
  (function(n, o) {
    function s(p, t) {
...
function e2() {
  ...
  function y(B, w) {
    var x = {};
    this._baseState = x, x.enc = B, x.parent = w || null, x.children = null, x.tag = null, x.args = null, x.reverseArgs = null, x.choice = null, x.optional = !1, x.any = !1, x.obj = !1, x.use = null, x.useDecoder = null, x.key = null, x.default = null, x.explicit = null, x.implicit = null, x.contains = null, x.parent || (x.children = [], this._wrap());
  }
  Kf = y;
  var S = [
    "enc",
  ...
  return y.prototype.clone = function() {
    ...
    f.forEach(function(x) {
      this[x] = function() {
        ...
        return w.children.push(k), k[x].apply(k, arguments);
      };
    }, this);
  }, y.prototype._init = function(w) {
    var x = this._baseState;
    s(x.parent === null), w.call(this), x.children = x.children.filter(function(I) {
      return I._baseState.parent === this;
    }, this), s.equal(x.children.length, 1, "Root node can have only one child");
  }, y.prototype._useArgs = function(w) {
    var x = this._baseState, I = w.filter(function(k) {
    ...
    }, this)), w.length !== 0 && (s(x.args === null), x.args = w, x.reverseArgs = w.map(function(k) {
  ...
  }), y.prototype.use = function(w) {
    s(w);
    var x = this._baseState;
    return s(x.use === null), x.use = w, this;
  }, y.prototype.optional = function() {
    var w = this._baseState;
    return w.optional = !0, this;
  }, y.prototype.def = function(w) {
    var x = this._baseState;
    return s(x.default === null), x.default = w, x.optional = !0, this;
  }, y.prototype.explicit = function(w) {
    var x = this._baseState;
    return s(x.explicit === null && x.implicit === null), x.explicit = w, this;
  }, y.prototype.implicit = function(w) {
    var x = this._baseState;
    return s(x.explicit === null && x.implicit === null), x.implicit = w, this;
  }, y.prototype.obj = function() {
    var w = this._baseState, x = Array.prototype.slice.call(arguments);
    return w.obj = !0, x.length !== 0 && this._useArgs(x), this;
  }, y.prototype.key = function(w) {
    var x = this._baseState;
    return s(x.key === null), x.key = w, this;
  }, y.prototype.any = function() {
    var w = this._baseState;
    return w.any = !0, this;
  }, y.prototype.choice = function(w) {
    var x = this._baseState;
    return s(x.choice === null), x.choice = w, this._useArgs(Object.keys(w).map(function(I) {
      return w[I];
    })), this;
  }, y.prototype.contains = function(w) {
    var x = this._baseState;
    return s(x.use === null), x.contains = w, this;
  }, y.prototype._decode = function(w, x) {
    var I = this._baseState;
    if (I.parent === null)
      return w.wrapResult(I.children[0]._decode(w, x));
    var k = I.default, D = !0, U = null;
    if (I.key !== null && (U = w.enterKey(I.key)), I.optional) {
      var W = null;
      if (I.explicit !== null ? W = I.explicit : I.implicit !== null ? W = I.implicit : I.tag !== null && (W = I.tag), W === null && !I.any) {
        var z = w.save();
        try {
          I.choice === null ? this._decodeGeneric(I.tag, w, x) : this._decodeChoice(w, x), D = !0;
        } catch (Ct) {
          D = !1;
        }
        w.restore(z);
      } else if (D = this._peekTag(w, W, I.any), w.isError(D))
        return D;
    }
    var $;
    if (I.obj && D && ($ = w.enterObject()), D) {
      if (I.explicit !== null) {
        var lt = this._decodeTag(w, I.explicit);
        if (w.isError(lt))
          return lt;
        w = lt;
      }
      ...
      if (I.use === null && I.choice === null) {
        ...
        if (w.isError(At))
          return At;
        I.any ? k = w.raw(z) : w = At;
      }
      if (x && x.track && I.tag !== null && x.track(w.path(), H, w.length, "tagged"), x && x.track && I.tag !== null && x.track(w.path(), w.offset, w.length, "content"), I.any ? k = k : I.choice === null ? k = this._decodeGeneric(I.tag, w, x) : k = this._decodeChoice(w, x), w.isError(k))
        return k;
      if (!I.any && I.choice === null && I.children !== null && I.children.forEach(function(Et) {
        Et._decode(w, x);
      }), I.contains && (I.tag === "octstr" || I.tag === "bitstr")) {
        var Bt = new o(k);
        k = this._getUse(I.contains, w._reporterState.obj)._decode(Bt, x);
      }
    }
    return I.obj && D && (k = w.leaveObject($)), I.key !== null && (k !== null || D === !0) ? w.leaveKey(U, I.key, k) : U !== null && w.exitKey(U), k;
  }, y.prototype._decodeGeneric = function(w, x, I) {
    var k = this._baseState;
    return w === "seq" || w === "set" ? null : w === "seqof" || w === "setof" ? this._decodeList(x, w, k.args[0], I) : /str$/.test(w) ? this._decodeStr(x, w, I) : w === "objid" && k.args ? this._decodeObjid(x, k.args[0], k.args[1], I) : w === "objid" ? this._decodeObjid(x, null, null, I) : w === "gentime" || w === "utctime" ? this._decodeTime(x, w, I) : w === "null_" ? this._decodeNull(x, I) : w === "bool" ? this._decodeBool(x, I) : w === "objDesc" ? this._decodeStr(x, w, I) : w === "int" || w === "enum" ? this._decodeInt(x, k.args && k.args[0], I) : k.use !== null ? this._getUse(k.use, x._reporterState.obj)._decode(x, I) : x.error("unknown tag: " + w);
  }, y.prototype._getUse = function(w, x) {
    var I = this._baseState;
    return I.useDecoder = this._use(w, x), s(I.useDecoder._baseState.parent === null), I.useDecoder = I.useDecoder._baseState.children[0], I.implicit !== I.useDecoder._baseState.implicit && (I.useDecoder = I.useDecoder.clone(), I.useDecoder._baseState.implicit = I.implicit), I.useDecoder;
  }, y.prototype._decodeChoice = function(w, x) {
    var I = this._baseState, k = null, D = !1;
    return Object.keys(I.choice).some(function(U) {
      var W = w.save(), z = I.choice[U];
      try {
        var $ = z._decode(w, x);
        if (w.isError($))
          return !1;
        ...
        return w.restore(W), !1;
      }
      return !0;
    }, this), D ? k : w.error("Choice not matched");
  }, y.prototype._createEncoderBuffer = function(w) {
    return new n(w, this.reporter);
  }, y.prototype._encode = function(w, x, I) {
    var k = this._baseState;
    if (!(k.default !== null && k.default === w)) {
      var D = this._encodeValue(w, x, I);
      if (D !== void 0 && !this._skipDefault(D, x, I))
        return D;
    }
  }, y.prototype._encodeValue = function(w, x, I) {
    var k = this._baseState;
    if (k.parent === null)
      return k.children[0]._encode(w, x || new a());
    var z = null;
    if (this.reporter = x, k.optional && w === void 0)
      if (k.default !== null)
        w = k.default;
      else
        return;
    var D = null, U = !1;
    if (k.any)
      z = this._createEncoderBuffer(w);
    else if (k.choice)
      z = this._encodeChoice(w, x);
    else if (k.contains)
      D = this._getUse(k.contains, I)._encode(w, x), U = !0;
    else if (k.children)
      D = k.children.map(function(H) {
        if (H._baseState.tag === "null_")
          return H._encode(null, x, w);
        ...
        var Bt = H._encode(w[H._baseState.key], x, w);
      ...
      var W = this.clone();
      W._baseState.implicit = null, D = this._createEncoderBuffer(w.map(function(H) {
        var At = this._baseState;
        return this._getUse(At.args[0], w)._encode(H, x);
      }, W));
    } else
      k.use !== null ? z = this._getUse(k.use, I)._encode(w, x) : (D = this._encodePrimitive(k.tag, w), U = !0);
    var z;
  ...
  }, y.prototype._encodeChoice = function(w, x) {
    var I = this._baseState, k = I.choice[w.type];
    return k || s(
      !1,
      w.type + " not found in " + JSON.stringify(Object.keys(I.choice))
    ), k._encode(w.value, x);
  }, y.prototype._encodePrimitive = function(w, x) {
    var I = this._baseState;
    if (/str$/.test(w))
      return this._encodeStr(x, w);
    if (w === "objid" && I.args)
      return this._encodeObjid(x, I.reverseArgs[0], I.args[1]);
    if (w === "objid")
      return this._encodeObjid(x, null, null);
    if (w === "gentime" || w === "utctime")
      return this._encodeTime(x, w);
    if (w === "null_")
    ...
    if (w === "objDesc")
      return this._encodeStr(x, w);
    throw new Error("Unsupported tag: " + w);
  }, y.prototype._isNumstr = function(w) {
    return /^[0-9 ]*$/.test(w);
  }, y.prototype._isPrintstr = function(w) {
...
function $o() {
  ...
  Vf = f, f.prototype.decode = function(w, x) {
    return w instanceof o.DecoderBuffer || (w = new o.DecoderBuffer(w, x)), this.tree._decode(w, x);
  };
  function g(B) {
    o.Node.call(this, "der", B);
  }
  a(g, o.Node), g.prototype._peekTag = function(w, x, I) {
    if (w.isEmpty())
      return !1;
    var k = w.save(), D = y(w, 'Failed to peek tag: "' + x + '"');
    return w.isError(D) ? D : (w.restore(k), D.tag === x || D.tagStr === x || D.tagStr + "of" === x || I);
  }, g.prototype._decodeTag = function(w, x, I) {
    var k = y(
      w,
    ...
    if (!I && k.tag !== x && k.tagStr !== x && k.tagStr + "of" !== x)
      return w.error('Failed to match tag: "' + x + '"');
    if (k.primitive || D !== null)
      return w.skip(D, 'Failed to match body of: "' + x + '"');
    var U = w.save(), W = this._skipUntilEnd(
      w,
      'Failed to skip indefinite length body: "' + this.tag + '"'
    );
    return w.isError(W) ? W : (D = w.offset - U.offset, w.restore(U), w.skip(D, 'Failed to match body of: "' + x + '"'));
  }, g.prototype._skipUntilEnd = function(w, x) {
    for (; ; ) {
      var I = y(w, x);
      if (w.isError(I))
        return I;
      var k = S(w, I.primitive, x);
      if (w.isError(k))
        return k;
      var D;
      if (I.primitive || k !== null ? D = w.skip(k) : D = this._skipUntilEnd(w, x), w.isError(D))
        return D;
      if (I.tagStr === "end")
        break;
    }
  }, g.prototype._decodeList = function(w, x, I, k) {
    for (var D = []; !w.isEmpty(); ) {
      var U = this._peekTag(w, "end");
      if (w.isError(U))
        return U;
      var W = I.decode(w, "der", k);
      if (w.isError(W) && U)
        break;
      D.push(W);
    }
    return D;
  }, g.prototype._decodeStr = function(w, x) {
    if (x === "bitstr") {
      var I = w.readUInt8();
      return w.isError(I) ? I : { unused: I, data: w.raw() };
    } else if (x === "bmpstr") {
      var k = w.raw();
      if (k.length % 2 === 1)
        return w.error("Decoding of string type: bmpstr length mismatch");
      for (var D = "", U = 0; U < k.length / 2; U++)
        D += String.fromCharCode(k.readUInt16BE(U * 2));
      return D;
    } else if (x === "numstr") {
      var W = w.raw().toString("ascii");
      return this._isNumstr(W) ? W : w.error("Decoding of string type: numstr unsupported characters");
    } else {
      if (x === "octstr")
        return w.raw();
      if (x === "objDesc")
        return w.raw();
      if (x === "printstr") {
        var z = w.raw().toString("ascii");
        return this._isPrintstr(z) ? z : w.error("Decoding of string type: printstr unsupported characters");
      } else
        return /str$/.test(x) ? w.raw().toString() : w.error("Decoding of string type: " + x + " unsupported");
    }
  }, g.prototype._decodeObjid = function(w, x, I) {
    for (var k, D = [], U = 0; !w.isEmpty(); ) {
      var W = w.readUInt8();
    ...
    return k;
  }, g.prototype._decodeTime = function(w, x) {
    var I = w.raw().toString();
    if (x === "gentime")
      ...
      return w.error("Decoding " + x + " time is not supported yet");
    return Date.UTC(k, D - 1, U, W, z, $, 0);
  }, g.prototype._decodeNull = function(w) {
    return null;
  }, g.prototype._decodeBool = function(w) {
    var x = w.readUInt8();
    return w.isError(x) ? x : x !== 0;
  }, g.prototype._decodeInt = function(w, x) {
    var I = w.raw(), k = new s(I);
    return x && (k = x[k.toString(10)] || k), k;
  }, g.prototype._use = function(w, x) {
    return typeof w == "function" && (w = w(x)), w._getDecoder("der").tree;
  };
  function y(B, w) {
    var x = B.readUInt8(w);
    if (B.isError(x))
    ...
    if ((x & 31) === 31) {
      var D = x;
      for (x = 0; (D & 128) === 128; ) {
        if (D = B.readUInt8(w), B.isError(D))
          return D;
        x <<= 7, x |= D & 127;
      }
    } else
...
function i2() {
  ...
  return a(s, o), Yf = s, s.prototype.decode = function(f, g) {
    for (var y = f.toString().split(/[\r\n]+/g), S = g.label.toUpperCase(), B = /^-----(BEGIN|END) ([^-]+)-----$/, w = -1, x = -1, I = 0; I < y.length; I++) {
      var k = y[I].match(B);
      if (k !== null && k[2] === S)
        if (w === -1) {
          if (k[1] !== "BEGIN")
...
function Lo() {
  ...
  Gf = f, f.prototype.encode = function(w, x) {
    return this.tree._encode(w, x).join();
  };
  function g(B) {
    s.Node.call(this, "der", B);
  }
  a(g, s.Node), g.prototype._encodeComposite = function(w, x, I, k) {
    var D = S(w, x, I, this.reporter);
    if (k.length < 128) {
      var z = new n(2);
  ...
  }, g.prototype._encodeStr = function(w, x) {
    if (x === "bitstr")
      return this._createEncoderBuffer([w.unused | 0, w.data]);
    if (x === "bmpstr") {
      for (var I = new n(w.length * 2), k = 0; k < w.length; k++)
        I.writeUInt16BE(w.charCodeAt(k), k * 2);
      return this._createEncoderBuffer(I);
    } else
      return x === "numstr" ? this._isNumstr(w) ? this._createEncoderBuffer(w) : this.reporter.error("Encoding of string type: numstr supports only digits and space") : x === "printstr" ? this._isPrintstr(w) ? this._createEncoderBuffer(w) : this.reporter.error("Encoding of string type: printstr supports only latin upper and lower case letters, digits, space, apostrophe, left and rigth parenthesis, plus sign, comma, hyphen, dot, slash, colon, equal sign, question mark") : /str$/.test(x) ? this._createEncoderBuffer(w) : x === "objDesc" ? this._createEncoderBuffer(w) : this.reporter.error("Encoding of string type: " + x + " unsupported");
  }, g.prototype._encodeObjid = function(w, x, I) {
    if (typeof w == "string") {
      if (!x)
    ...
    if (!Array.isArray(w))
      return this.reporter.error("objid() should be either array or string, got: " + JSON.stringify(w));
    if (!I) {
      if (w[1] >= 40)
        return this.reporter.error("Second objid identifier OOB");
      w.splice(0, 2, w[0] * 40 + w[1]);
    }
    for (var D = 0, k = 0; k < w.length; k++) {
      var U = w[k];
      for (D++; U >= 128; U >>= 7)
        D++;
    }
    for (var W = new n(D), z = W.length - 1, k = w.length - 1; k >= 0; k--) {
      var U = w[k];
      for (W[z--] = U & 127; (U >>= 7) > 0; )
        W[z--] = 128 | U & 127;
    }
  ...
  g.prototype._encodeTime = function(w, x) {
    var I, k = new Date(w);
    return x === "gentime" ? I = [
      y(k.getFullYear()),
      y(k.getUTCMonth() + 1),
  ...
  }, g.prototype._encodeInt = function(w, x) {
    if (typeof w == "string") {
      if (!x)
        return this.reporter.error("String int or enum given, but no values map");
      if (!x.hasOwnProperty(w))
        return this.reporter.error("Values map doesn't contain: " + JSON.stringify(w));
      w = x[w];
    }
    if (typeof w != "number" && !n.isBuffer(w)) {
      var I = w.toArray();
      !w.sign && I[0] & 128 && I.unshift(0), w = new n(I);
    }
    if (n.isBuffer(w)) {
      var k = w.length;
      w.length === 0 && k++;
      var U = new n(k);
      return w.copy(U), w.length === 0 && (U[0] = 0), this._createEncoderBuffer(U);
    }
    if (w < 128)
      return this._createEncoderBuffer(w);
    if (w < 256)
      return this._createEncoderBuffer([0, w]);
    for (var k = 1, D = w; D >= 256; D >>= 8)
      k++;
    for (var U = new Array(k), D = U.length - 1; D >= 0; D--)
      U[D] = w & 255, w >>= 8;
    return U[0] & 128 && U.unshift(0), this._createEncoderBuffer(new n(U));
  }, g.prototype._encodeBool = function(w) {
    return this._createEncoderBuffer(w ? 255 : 0);
  }, g.prototype._use = function(w, x) {
    return typeof w == "function" && (w = w(x)), w._getEncoder("der").tree;
  }, g.prototype._skipDefault = function(w, x, I) {
  ...
  function S(B, w, x, I) {
    ...
    return k >= 31 ? I.error("Multi-octet tag encoding unsupported") : (w || (k |= 32), k |= m.tagClassByName[x || "universal"] << 6, k);
  }
  return Gf;
}
var Xf, hh;
function f2() {
  ...
  return a(o, n), Xf = o, o.prototype.encode = function(m, f) {
...
var nr = sn(), uh = nr.define("Time", function() {
...
}), j0 = nr.define("AlgorithmIdentifier", function() {
  this.seq().obj(
  ...
  this.seq().obj(
    ...
    this.key("signatureAlgorithm").use(j0),
...
}, Pe = ir, T2 = S2, C2 = R2, F2 = Oe, q2 = zn, b0 = zt.Buffer;
function P2(a, n) {
  var o = a.algorithm.decrypt.kde.kdeparams.salt, s = parseInt(a.algorithm.decrypt.kde.kdeparams.iters.toString(), 10), m = T2[a.algorithm.decrypt.cipher.algo.join(".")], f = a.algorithm.decrypt.cipher.iv, g = a.subjectPrivateKey, y = parseInt(m.split("-")[1], 10) / 8, S = q2.pbkdf2Sync(n, o, s, y, "sha1"), B = F2.createDecipheriv(m, S, f), w = [];
  return w.push(B.update(g)), w.push(B.final()), b0.concat(w);
}
function Oo(a) {
  var n;
  typeof a == "object" && !b0.isBuffer(a) && (n = a.passphrase, a = a.key), typeof a == "string" && (a = b0.from(a));
...
function D2() {
  if (dh)
    return Pi.exports;
  dh = 1;
  var a = zt.Buffer, n = Gh, o = H0, s = G0().ec, m = K0, f = lf, g = zo, y = 1;
...
function N2() {
  if (ch)
    return jf;
  ch = 1;
  var a = zt.Buffer, n = K0, o = G0().ec, s = lf, m = zo;
  function f(B, w, x, I, k) {
    var D = s(x);
    if (D.type === "ec") {
    ...
    if (I !== "rsa" && I !== "ecdsa/rsa")
      throw new Error("wrong public key type");
    w = a.concat([k, w]);
    for (var U = D.modulus.byteLength(), W = [1], z = 0; w.length + W.length + 2 < U; )
      W.push(255), z += 1;
    W.push(0);
    for (var $ = -1; ++$ < w.length; )
      W.push(w[$]);
  ...
  function g(B, w, x) {
    ...
    return k.verify(w, B, D);
  }
  function y(B, w, x) {
    var I = x.data.p, k = x.data.q, D = x.data.g, U = x.data.pub_key, W = s.signature.decode(B, "der"), z = W.s, $ = W.r;
    S(z, k), S($, k);
    var lt = n.mont(I), H = z.invm(k), At = D.toRed(lt).redPow(new n(w).mul(H).mod(k)).fromRed().mul(U.toRed(lt).redPow($.mul(H).mod(k)).fromRed()).mod(I).mod(k);
    return At.cmp($) === 0;
  }
  function S(B, w) {
    if (B.cmpn(0) <= 0)
...
var Ko = {}, O2 = Qi, y0 = zt.Buffer, Ho = function(a, n) {
  for (var o = y0.alloc(0), s = 0, m; o.length < n; )
    m = z2(s++), o = y0.concat([o, O2("sha1").update(a).update(m).digest()]);
  return o.slice(0, n);
};
function z2(a) {
  var n = y0.allocUnsafe(4);
...
var ea = ta.exports, mh = ea, K2 = zt.Buffer;
function H2(a, n) {
  return K2.from(a.toRed(mh.mont(n.modulus)).redPow(new mh(n.publicExponent)).fromRed().toArray());
}
var Wo = H2, Z2 = lf, w0 = yi, W2 = Qi, gh = Ho, bh = Zo, ra = ea, V2 = Wo, Y2 = H0, Qe = zt.Buffer, J2 = function(n, o, s) {
  var m;
  ...
  if (m === 4)
    ...
    if (g = new ra(o), g.cmp(f.modulus) >= 0)
...
function G2(a, n) {
  ...
  var y = Qe.alloc(o - s - g - 2), S = o - f - 1, B = w0(f), w = bh(Qe.concat([m, y, Qe.alloc(1, 1), n], S), gh(B, S)), x = bh(B, gh(w, f));
  return new ra(Qe.concat([Qe.alloc(1), x, w], o));
}
function X2(a, n, o) {
  ...
  if (s > m - 11)
    throw new Error("message too long");
  var f;
  return o ? f = Qe.alloc(m - s - 3, 255) : f = j2(m - s - 3), new ra(Qe.concat([Qe.from([0, o ? 1 : 2]), f, Qe.alloc(1), n], m));
}
function j2(a) {
  for (var n = Qe.allocUnsafe(a), o = 0, s = w0(a * 2), m = 0, f; o < a; )
    m === s.length && (s = w0(a * 2), m = 0), f = s[m++], f && (n[o++] = f);
  return n;
}
var Q2 = lf, yh = Ho, wh = Zo, Mh = ea, tg = H0, eg = Qi, rg = Wo, Vi = zt.Buffer, ig = function(n, o, s) {
  var m;
  n.padding ? m = n.padding : s ? m = 1 : m = 4;
...
var Vo = zt, _h = yi, Yo = Vo.Buffer, Jo = Vo.kMaxLength, M0 = Xt.crypto || Xt.msCrypto, Go = Math.pow(2, 32) - 1;
function Xo(a, n) {
...
M0 && M0.getRandomValues || !we.browser ? (Ui.randomFill = hg, Ui.randomFillSync = sg) : (Ui.randomFill = xh, Ui.randomFillSync = xh);
function hg(a, n, o, s) {
...
function tu() {
  if (Sh)
    return Ut;
  Sh = 1, Ut.randomBytes = Ut.rng = Ut.pseudoRandomBytes = Ut.prng = yi, Ut.createHash = Ut.Hash = Qi, Ut.createHmac = Ut.Hmac = Gh;
  ...
  var g = $2();
  Ut.createSign = g.createSign, Ut.Sign = g.Sign, Ut.createVerify = g.createVerify, Ut.Verify = g.Verify, Ut.createECDH = U2();
  var y = Ko;
...
function Cn(a) {
  const n = a || (typeof process != "undefined" ? process.env.NEXT_PUBLIC_NODE_ENV || process.env.NODE_ENV : "production");
